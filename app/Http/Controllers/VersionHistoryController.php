            ...
            return Datatables::of($items)
                ...
                ->addColumn('actions', function ($item) {
                    ...
                    return '<div class="d-flex gap-1 justify-content-center flex-nowrap">' .
                        '<a href="' . e($showUrl) . '" class="btn btn-sm btn-primary rounded-8 px-3 text-nowrap">Papar</a>' .
                        '<a href="' . e($editUrl) . '" class="btn btn-sm btn-warning rounded-8 px-3 text-nowrap">Kemaskini</a>' .
                        '<form method="POST" action="' . e($destroyUrl) . '" class="d-inline">' . $csrf . '<input type="hidden" name="_method" value="DELETE">' .
                        '<button type="button" class="btn btn-sm btn-danger rounded-8 px-3 text-nowrap confirm-delete">Padam</button></form>' .
                        '</div>';
                })
