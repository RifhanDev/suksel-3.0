...
class Vendor extends Model
{
	...
	*/
	...
	public function vendorCodes() {
		return $this->hasMany(VendorCode::class);
	}
	
	public function cidbGrades() {
		return $this->hasMany(VendorCode::class)->whereCodeType('cidb-g');
	}
	
	public function blacklists() {
		return $this->hasMany(VendorBlacklist::class);
	}
	...
	public function assets() {
		return $this->hasMany(VendorAsset::class, 'vendor_id', 'id');
	}
	...
	public function codeChanges() {
		return $this->hasMany(CodeRequest::class);
	}
	
	public function histories() {
		return $this->hasMany(VendorHistory::class, 'vendor_id');
	}
	...
	{
		return $this -> hasMany(TenderVendor::class, 'vendor_id');
	}
