...
trait UploadableTrait
{
  ...
  public function multiUploader($size = 2, $type = 'image/*', $files = null) 
  {
    ...
    $id = $this->id;
    return view('uploads.multi', compact('class', 'id', 'size', 'type', 'files'));
  }
  ...
  public function singleUploader($size = 2, $type = 'image/*', $files = null) 
  {
    $class = get_class($this);
    $id = $this->id;
    return view('uploads.single', compact('class', 'id', 'size', 'type', 'files'));
  }
  ...
  {
    $class = __CLASS__;
    return view('uploads.multi', compact('class', 'size', 'type', 'files'));
  }
  ...
  {
    $class = __CLASS__;
    return view('uploads.single', compact('class', 'size', 'type'));
  }

  public function uploadsTable()
  {
    $uploads = $this->uploads;
    return view('uploads.show', compact('uploads'));
  }
} 
