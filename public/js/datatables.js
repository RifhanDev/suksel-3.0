...
(function (factory) {
  ...
  /* Default class modification and paging helpers
   * Only apply if DataTables core is present to avoid
   * errors on pages that load this file without DataTables.
   */
  if ($.fn.dataTableExt) {
    ...
    $.extend($.fn.dataTableExt.oPagination, {
      bs_normal: {
        fnInit: function (oSettings, nPaging, fnDraw) {
          ...
          $(nPaging).append(
            '<ul class="pagination">' +
              '<li class="prev disabled"><a href="#"><span class="' +
              oSettings.oLanguage.sIconClassPrevious +
              '"></span>&nbsp;' +
              oLang.sPrevious +
              "</a></li>" +
              ...
              oLang.sNext +
              '&nbsp;<span class="' +
              oSettings.oLanguage.sIconClassNext +
              '"></span></a></li>' +
              "</ul>",
          );
          var els = $("a", nPaging);
        ...
        fnInit: function (oSettings, nPaging, fnCallbackDraw) {
          ...
          $(nPaging).append(
            '<ul class="pagination">' +
              ...
              oClasses.sPageFirst +
              '"><span class="' +
              oSettings.oLanguage.sIconClassFirst +
              '"></span>&nbsp;' +
              oLang.sFirst +
              "</a></li>" +
              '<li class="disabled"><a  tabindex="' +
              ...
              oLang.sLast +
              '&nbsp;<span class="' +
              oSettings.oLanguage.sIconClassLast +
              '"></span></a></li>' +
              "</ul>",
          );
          var els = $("a", nPaging);
