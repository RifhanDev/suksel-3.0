...
@section('content')
	...
	<div class="well">
		...
		@if ($blacklist->file)
			<a href="{{ route('vendor.blacklists.file', [$vendor->id, $blacklist->id]) }}" target="_blank"
				class="btn btn-default">Lihat Lampiran</a>
		@endif
		...
		{!! Former::close() !!} --}}
			<a href="{{ route('vendor.blacklists.unblacklist', [$blacklist->vendor_id, $blacklist->id]) }}"
				class="btn btn-danger">Batal</a>
		@endif

		<a href="{{ route('vendor.blacklists.index', $vendor->id) }}" class="btn btn-default pull-right">Maklumat Senarai
			Hitam</a>
	</div>
	{!! Former::close() !!}
@endsection
