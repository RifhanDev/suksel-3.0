...
<style>
    ...
    .action-tile-compact {
        ...
        transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1); /* Smoother physics */
        position: relative;
        overflow: hidden;
    ...
    .action-tile-compact:hover {
        transform: translateY(-5px); /* Clear lift */
        border-color: var(--sg-red); /* Elegant full red border */
        box-shadow: 0 12px 24px -6px rgba(196, 30, 58, 0.15); /* Soft red shadow */
    }
    ...
    .link-slide-underline:hover::after { width: 97%; }
</style>
@endsection
...
@section('content')
            ...
            <div class="row g-3">
                ...
                @if (App\CodeRequest::canCreateFor($vendor->id, 'mof'))
                    <div class="col-md-6 col-xl-3">
                        <a href="{{ route('vendor.requests.create', [$vendor->id, 'type' => 'mof']) }}" class="action-tile-compact">
                            <div class="tile-icon">
                ...
                @if (App\CodeRequest::canCreateFor($vendor->id, 'cidb'))
                    <div class="col-md-6 col-xl-3">
                        <a href="{{ route('vendor.requests.create', [$vendor->id, 'type' => 'cidb']) }}" class="action-tile-compact">
                            <div class="tile-icon">
                ...
                @if (App\CodeRequest::canCreateFor($vendor->id, 'district'))
                    <div class="col-md-6 col-xl-3">
                        <a href="{{ route('vendor.requests.create', [$vendor->id, 'type' => 'district']) }}" class="action-tile-compact">
                            <div class="tile-icon">
                ...
                @if (App\CodeRequest::canCreateFor($vendor->id, 'email'))
                    <div class="col-md-6 col-xl-3">
                        <a href="{{ route('vendor.requests.create', [$vendor->id, 'type' => 'email']) }}" class="action-tile-compact">
                            <div class="tile-icon">
	...
	<div class="stats-card mb-3">
        ...
        <div class="stats-card-header">
            <h3 class="stats-card-title d-flex align-items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="ms-2" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#c41e3a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg>
    ...
    @if (isset($vendor) && $vendor->canShow())
        <div class="d-flex justify-content-start pb-5">
            <a href="{{ asset(Auth::user()->hasRole('Vendor') ? 'vendor' : 'vendors/' . $vendor->id) }}" class="btn btn-link text-secondary text-decoration-none d-flex align-items-center gap-2 link-slide-underline">
