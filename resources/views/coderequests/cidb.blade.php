...
@section('content')
	<h2 class="tender-title">Masukkan Permintaan Kemaskini CIDB</h2>
	...
	<div class="form-group">
		...
		<div class="col-lg-9 col-sm-9">
			<div class="input-group">
				<input class="form-control" id="cidb_start_date" type="text" name="cidb_start_date"
					value="{{ Carbon\Carbon::parse($vendor->cidb_start_date)->format('j M Y') }}">
				<div class="input-group-addon">hingga</div>
				<input class="form-control" id="cidb_end_date" type="text" name="cidb_end_date"
					value="{{ Carbon\Carbon::parse($vendor->cidb_end_date)->format('j M Y') }}">
			</div>
		</div>
	</div>
	{!! Former::checkbox('cidb_bumi')->inline()->label('Syarikat Bumiputera') !!}
	<div class="form-group">
		...
		<div class="col-lg-9 col-sm-9">
			<div id="cidb_group">
				<div id="cidb_group_template" class="cidb-group-template">
					...
					<select id="cidb_group_#index#_code_id" class="cidb_group-code_id form-control selectize"
						name="cidb_group[#index#][code_id]">
					...
					<select id="cidb_group_#index#_codes" class="cidb_group-codes form-control selectize"
						name="cidb_group[#index#][codes][]" multiple="multiple">
	...
	{!! Former::file('sijil_cidb')->label('Sijil SPKK & CIDB')->accept('application/pdf')->help('Muat naik fail sijil SPKK & CIDB sebagai satu fail sahaja.')->required() !!}
	{!! Former::file('sijil_cidb_bumiputera')->label('Sijil Bumiputera PKK')->accept('application/pdf')->help('Muat naik fail berkaitan untuk tujuan pengesahan. Hanya fail beformat PDF sahaja.') !!}
