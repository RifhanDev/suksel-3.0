...
@section('content')
	...
	{!! Former::select('district_id')->id('district_id')->label('Daerah')->options($district_list)->select('')->required() !!}

	<div id="state_id_div" class="form-group"
	...
	{!! Former::file('sijil_daerah')->name('sijil_daerah')->label('Dokumen Sokongan')->accept('application/pdf')->help('Muat naik dokumen sokongan seperti sijil SPKK &amp; CIDB untuk rujukan.')->required() !!}
