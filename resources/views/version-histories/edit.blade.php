        ...
        <div class="content-card-body p-4">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="version" class="form-control" value="{{ old('version', $versionHistory->version) }}" placeholder="Contoh: 1.0" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-medium small">Tarikh <span class="text-danger">*</span></label>
                    <input type="text" name="released_at" class="form-control datepicker" value="{{ old('released_at', $versionHistory->released_at ? $versionHistory->released_at->format('d M Y') : '') }}" placeholder="Pilih tarikh..." required readonly>
                </div>
                <div class="col-12">
