...
<html>
	<head>
		...
		<title>Sahkan Alamat Emel | Tender Online SUK Selangor</title>
		<style type="text/css">
									                			...
									                			<tr>
									                				<td align="left" valign="top" class="mob_center">
									                  				<a href="{{ URL::to('/') }}" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
									                  					...
									                  					<img src="{{ asset('assets/images/header.png') }}" height="75" alt="Tender Online SUK Selangor" border="0" border="0" style="display: block;" /></font>
									                  				</a>
									                				</td>
									                			</tr>
									              			</table>            
						  		...
						  		<td align="center" bgcolor="#ffffff">
						    		<table width="90%" border="0" cellspacing="0" cellpadding="0">
									                	...
									                	<div style="line-height: 24px;">
									                  	<font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 16px;">
									                  		<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
									                    			Sila sahkan alamat emel anda dengan menekan butang di bawah.
									                  		</span>
									                  	</font>
									                	</div>
								              		</td>
						      		...
						      		<tr>
						      			<td align="center">
									        	<div style="line-height:24px;">
									          	<a href="{{ url('auth/confirm/'.$confirmation_code) }}" target="_blank" style="background: #F3565D; font-family: Arial, Helvetica, sans-serif; font-size: 13px; padding: 15px 30px;  text-decoration: none;">
