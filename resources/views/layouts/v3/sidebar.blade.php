		...
		<ul class="sidebar-nav">
			...
			<li class="nav-item">
				...
				<div class="collapse" id="menuTender">
					...
					<ul class="sidebar-submenu">
						...
						<li><a class="submenu-item" href="{{ route('ciptaTender') }}">
								<div class="submenu-icon"></div><span>Cipta Tender</span>
							</a></li>
			...
			<li class="nav-item">
				...
				<div class="collapse" id="menuDashboard">
					<ul class="sidebar-submenu">
						<li><a class="submenu-item" href="{{ asset('dashboard/hq') }}">
								<div class="submenu-icon"></div><span>Dashboard Pengurusan</span>
							</a></li>
					</ul>
				</div>
			</li>
