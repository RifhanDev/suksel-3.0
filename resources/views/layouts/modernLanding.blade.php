...
<body>
    <div class="page">
                ...
                <ul class="navbar-nav-horizontal">
                    <li class="nav-item">
                        <a href="{{ action('HomeController@index') }}"
                            class="nav-link {{ request()->is('/') ? 'active' : '' }}" title="Halaman Utama">
                    ...
                    <li class="nav-item">
                        <a href="{{ action('HomeController@prices') }}"
                            class="nav-link {{ request()->is('prices*') ? 'active' : '' }}" title="Senarai Tender">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a href="{{ action('HomeController@results') }}"
                            class="nav-link {{ request()->is('results*') ? 'active' : '' }}" title="Penender Berjaya">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('circulars.public') }}"
                            class="nav-link {{ request()->is('circulars*') ? 'active' : '' }}" title="Pekeliling">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('aduan.create') }}"
                            class="nav-link {{ request()->is('aduan*') ? 'active' : '' }}" title="Aduan">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="currentColor"
                    ...
                    <li class="nav-item dropdown">
                        <a href="#navbar-help"
                            ...
                            id="navbarDropdownPertanyaan" role="button" data-bs-toggle="dropdown"
                    ...
                    <li class="nav-item dropdown">
                        <a href="#navbar-agencies"
                            ...
                            id="navbarDropdownAgensi" role="button" data-bs-toggle="dropdown"
                            data-bs-auto-close="outside" data-bs-display="static" aria-expanded="false"
                            title="Agensi">
                            <span class="nav-link-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownAgensi">
                            ...
                            @foreach ($__orgTypes as $type)
                                <a class="dropdown-item"
                                    href="{{ route('agencies.index', ['type' => $type->id]) }}">{{ $type->name }}</a>
                            @endforeach
                        </div>
                    </li>
                </ul>
                ...
                <div class="navbar-actions">
                    @if (!Auth::check())
                        ...
                        <div class="action-links d-none d-xl-flex">
                            <a href="{{ route('manuals.show', 'pendaftaran') }}" target="_blank"
                                class="action-link-item" title="Panduan pendaftaran vendor">
                        ...
                        <div class="action-buttons">
                            <a href="{{ asset('register') }}" class="btn-auth btn-auth-outline"
                                title="Daftar akaun vendor baharu">
                            ...
                            <a href="{{ route('login') }}" class="btn-auth btn-auth-solid text-decoration-none"
                                title="Log masuk ke sistem">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path
                    ...
                    @else
                        ...
                        <div class="nav-item dropdown user-nav-item">
                            <a href="#" class="user-chip-toggle dropdown-toggle" data-bs-toggle="dropdown"
                                data-bs-auto-close="outside" data-bs-display="static" aria-expanded="false">

                                <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}&background=c41e3a&color=fff"
        ...
        <div class="mobile-sidebar" id="mobileSidebar">
            <nav>
                ...
                <div class="mobile-nav-item">
                    <a href="{{ action('HomeController@prices') }}"
                        class="mobile-nav-link {{ request()->is('prices*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="currentColor">
                            <path
                                d="M11 2l3 .001v5.999a1 1 0 0 0 .883 .993l.117 .007h6v6a3 3 0 0 1 -3 3h-1v1a3 3 0 0 1 -3 3h-7a3 3 0 0 1 -3 -3v-10a3 3 0 0 1 3 -3h1v-1a3 3 0 0 1 3 -3m-3 6h-1a1 1 0 0 0 -1 1v10a1 1 0 0 0 1 1h7a1 1 0 0 0 1 -1v-1h-4a3 3 0 0 1 -3 -3zm12.415 -1h-4.415v-4.415z" />
                ...
                <div class="mobile-nav-item">
                    <a href="{{ action('HomeController@results') }}"
                        class="mobile-nav-link {{ request()->is('results*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="currentColor">
                            <path
                                d="M17 3a1 1 0 0 1 .993 .883l.007 .117v2.17a3 3 0 1 1 0 5.659v.171a6.002 6.002 0 0 1 -5 5.917v2.083h3a1 1 0 0 1 .117 1.993l-.117 .007h-8a1 1 0 0 1 -.117 -1.993l.117 -.007h3v-2.083a6.002 6.002 0 0 1 -4.996 -5.692l-.004 -.225v-.171a3 3 0 0 1 -3.996 -2.653l-.003 -.176l.005 -.176a3 3 0 0 1 3.995 -2.654l-.001 -2.17a1 1 0 0 1 1 -1h10zm-12 5a1 1 0 1 0 0 2a1 1 0 0 0 0 -2zm14 0a1 1 0 1 0 0 2a1 1 0 0 0 0 -2z" />
                ...
                <div class="mobile-nav-item">
                    <a href="{{ route('circulars.public') }}"
                        class="mobile-nav-link {{ request()->is('circulars*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="currentColor">
                            <path
                                d="M17.997 4.17a3 3 0 0 1 2.003 2.83v12a3 3 0 0 1 -3 3h-10a3 3 0 0 1 -3 -3v-12a3 3 0 0 1 2.003 -2.83a4 4 0 0 0 3.997 3.83h4a4 4 0 0 0 3.98 -3.597zm-8.987 10.83h-.01a1 1 0 0 0 -.117 1.993l.127 .007a1 1 0 0 0 0 -2m5.99 0h-2a1 1 0 0 0 0 2h2a1 1 0 0 0 0 -2m-5.99 -4h-.01a1 1 0 0 0 -.117 1.993l.127 .007a1 1 0 0 0 0 -2m5.99 0h-2a1 1 0 0 0 0 2h2a1 1 0 0 0 0 -2m-1 -9a2 2 0 1 1 0 4h-4a2 2 0 1 1 0 -4z" />
                ...
                <div class="mobile-nav-item">
                    <a href="{{ route('aduan.create') }}"
                        class="mobile-nav-link {{ request()->is('aduan*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="currentColor">
                            <path
                                d="M18 3a4 4 0 0 1 4 4v8a4 4 0 0 1 -4 4h-4.724l-4.762 2.857a1 1 0 0 1 -1.508 -.743l-.006 -.114v-2h-1a4 4 0 0 1 -3.995 -3.8l-.005 -.2v-8a4 4 0 0 1 4 -4zm-6 10a1 1 0 0 0 -1 1v.01a1 1 0 0 0 2 0v-.01a1 1 0 0 0 -1 -1m0 -6a1 1 0 0 0 -1 1v3a1 1 0 0 0 2 0v-3a1 1 0 0 0 -1 -1" />
                ...
                <div class="mobile-nav-item">
                    <button class="mobile-dropdown-toggle" data-dropdown="pertanyaan">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            ...
                            stroke-linejoin="round" class="dropdown-arrow">
                            <path d="M6 9l6 6l6 -6" />
                        </svg>
                    </button>
                ...
                <div class="mobile-nav-item">
                    ...
                    <div class="mobile-dropdown-content" id="dropdown-agensi">
                        ...
                        @endphp
                        @foreach ($__orgTypes as $type)
                            {{-- <a href="{{ action('OrganizationUnitsController@index', ['type' => $type->id]) }}" --}}
                            <a href="{{ route('agencies.index', ['type' => $type->id]) }}"
                                class="mobile-dropdown-item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    viewBox="0 0 24 24" fill="currentColor">
                                    <path
                                        d="M18 2a3 3 0 0 1 2.995 2.824l.005 .176v16a1 1 0 0 1 -.883 .993l-.117 .007h-5a1 1 0 0 1 -.993 -.883l-.007 -.117v-3h-2v3a1 1 0 0 1 -.883 .993l-.117 .007h-5a1 1 0 0 1 -.993 -.883l-.007 -.117v-16a3 3 0 0 1 2.824 -2.995l.176 -.005h10zm-6 6h-1a1 1 0 1 0 0 2h1a1 1 0 0 0 0 -2zm4 0h-1a1 1 0 0 0 0 2h1a1 1 0 0 0 0 -2z" />
                                </svg>
                                {{ $type->name }}
                            </a>
                        @endforeach
    ...
    <script src="https://cdn.datatables.net/v/dt/dt-2.3.5/datatables.min.js"
        integrity="sha384-qH0inyYSCOpaLgM/WSarLVnq0ULwworkGFzUI+E6bpx0DUCIsJePT0TRDnLnkcU1" crossorigin="anonymous">
    </script>
