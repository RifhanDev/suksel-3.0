	...
	<div class="row justify-content-center">
		...
		<div class="col-lg-6 col-xl-5">
			<div class="stats-card p-4 h-100">
				...
				@if (config('app.debug'))
					<form action="{{ action('RegistrationController@storePayment') }}" method="POST">
						@csrf
						<button type="submit" class="payment-option-btn text-dark shadow-none border-success">
							<div class="d-flex align-items-center gap-3">
								...
								<div>
									<div class="fw-bold text-success">Bypass Pembayaran (Dev)</div>
									<div class="small text-muted">Aktifkan akaun tanpa pembayaran</div>
								</div>
							</div>
							<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
				...
				@if ($fpx || $ebpg)
					...
					<div class="payment-list">
						{{-- CREDIT CARD --}}
						@if ($ebpg)
							<button type="button" name="method" id="method-cc" value="ebpg"
								class="payment-option-btn text-dark shadow-none"
								onclick="$('input[name=method]').val('ebpg'); this.form.submit();">
								<div class="d-flex align-items-center gap-3">
						...
						@if ($fpx)
							<div class="dropdown mb-3">
								<button class="payment-option-btn text-dark shadow-none w-100" type="button" data-bs-toggle="dropdown"
									aria-expanded="false">
									<div class="d-flex align-items-center gap-3">
										<div class="payment-icon-box text-primary">
											<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
												...
												<path d="M5 10V7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v3"></path>
