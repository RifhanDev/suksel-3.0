...
<head>
	...
	<title>Pendaftaran Diterima | Sistem Tender Online Selangor</title>
	<style type="text/css">
		html {
								...
								<table width="90%" border="0" cellspacing="0" cellpadding="0">
														...
														<div style="line-height: 24px;">
															<font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 16px;">
																<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
																	Terima kasih kerana mendaftar dengan Sistem Tender Online Selangor. Pendaftaran anda telah diterima dan
																	sedang dalam proses semakan oleh pentadbir sistem.
																	<br><br>
																	<strong>Maklumat Pendaftaran:</strong><br>
																	No. Pendaftaran: <strong>{{ $vendor->registration }}</strong><br>
																	Nama Syarikat: <strong>{{ $vendor->name }}</strong><br>
																	Email: <strong>{{ $vendor->user->email }}</strong>
																	<br><br>
																	Anda akan menerima emel pengesahan setelah pendaftaran anda diluluskan oleh pentadbir.
																</span>
															</font>
														</div>
													</td>
									...
									<tr>
										<td align="center">
											<div style="line-height:24px;">
												<a href="{{ URL::to('/') }}" target="_blank"
													style="background: #4db3a4; font-family: Arial, Helvetica, sans-serif; font-size: 13px; padding: 15px 30px;  text-decoration: none;">
