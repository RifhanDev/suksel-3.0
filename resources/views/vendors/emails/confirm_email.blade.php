...
<title>Pengesahan Alamat Emel | Sistem Tender Online Selangor</title>
<style type="text/css">
...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
            ...
            <tr><td align="left" valign="middle">
              ...
              <table width="115" border="0" cellspacing="0" cellpadding="0" >
                <tr><td align="left" valign="top" class="mob_center">
                  ...
                  <img src="{{ asset('assets/images/header.png') }}" height="75" alt="Tender Online SUK Selangor" border="0" border="0" style="display: block;" /></font></a>
                </td></tr>
              </table>            
            </td></tr>
  ...
  <tr><td align="center" bgcolor="#ffffff">
    <table width="90%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr><td align="center">
                <div style="line-height: 24px;">
                  ...
                  <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                    Tujuan emel ini dihantar adalah bagi menyemak satu emel anda di Sistem Tender Online Selangor 2.0. Tekan butang di bawah bagi mengesahkan alamat emel.
                  </span></font>
                </div>
              </td></tr>
            </table>
      ...
      <tr><td align="center">
        <div style="line-height:24px;">
          <a href="{{ URL::route('confirm_email', [$user->email_token]) }}" target="_blank" style="background: #F3565D; font-family: Arial, Helvetica, sans-serif; font-size: 13px; padding: 15px 30px;  text-decoration: none;">
