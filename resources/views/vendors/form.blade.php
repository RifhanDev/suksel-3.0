...
<div ng-controller="VendorController" {{strstr(Route::currentRouteName(), 'show') ? 'ng-init="show=true"' : 'ng-init="show=false"'}}>
    ...
    <div class="modern-tabs-header" style="padding-top:0; padding-bottom:0;">
        <ul class="modern-nav-tabs nav">
            <li class="active"><a href="#vf-main" data-toggle="tab">Syarikat</a></li>
            <li><a href="#vf-officer" data-toggle="tab">Pegawai</a></li>
            
            <?php if(!isset($vendor->approval_1_id) || Auth::user()->can('Vendor:override')) : ?>
                <li><a href="#vf-mof" data-toggle="tab">MOF</a></li>
                <li><a href="#vf-cidb" data-toggle="tab">CIDB</a></li>
            <?php endif; ?>

            <li><a href="#vf-shareholders" data-toggle="tab">Pemegang Saham</a></li>
            <li><a href="#vf-directors" data-toggle="tab">Pengarah</a></li>

            @if(isset($vendor) && $vendor->approval_1_id > 0)
                <li><a href="#vf-contacts" data-toggle="tab">Kakitangan</a></li>
                <li><a href="#vf-awards" data-toggle="tab">Anugerah</a></li>
                <li><a href="#vf-assets" data-toggle="tab">Aset</a></li>
                <li><a href="#vf-projects" data-toggle="tab">Projek</a></li>
                <li><a href="#vf-products" data-toggle="tab">Produk</a></li>
            @endif

            <li><a href="#vf-files" data-toggle="tab">Fail</a></li>
        </ul>
    </div>
            ...
            <div class="form-grid-2">
                ...
                <div>
                    @if(!isset($vendor))
                        ...
                        {!! Former::text('registration')->required()->data_ng_blur('uppercaseInputValue($event)')->placeholder("Aksara, Nombor dan tanda '-' Sahaja")->label('No. Pendaftaran') !!}
                    @else
                        <?php 
                    ...
                    <div id="state_id_div" class="form-group" style="{{ ($district == 0) ? '' : 'display:none' }}">
                        <label for="state_id" class="control-label">Negeri<sup>*</sup></label>
                ...
                <div>
                    ...
                    <div class="form-group">
                        <label for="ssm_expiry" class="control-label">Tarikh Tamat Sijil SSM <sup>*</sup></label>
                    ...
                    <div class="form-group">
                        <label for="authorized_capital" class="control-label">Modal Dibenarkan</label>
                    ...
                    <div class="form-group">
                        <label for="paidup_capital" class="control-label">Modal Berbayar</label>
                        <div class="modern-input-group">
        ...
        <div class="tab-pane" id="vf-mof">
            <div class="form-grid-2">
                <div>
                    ...
                    <div class="form-group">
                        <label for="mof_start_date" class="control-label">Tarikh Aktif</label>
                        <div class="modern-input-group">
        ...
        <div class="tab-pane" id="vf-cidb">
            <div class="form-grid-2">
                ...
                <div>
                    ...
                    <div class="form-group">
                        <label for="cidb_start_date" class="control-label">Tarikh Aktif</label>
                        <div class="modern-input-group">
                ...
                <div style="grid-column: 1 / -1;">
                    <label class="control-label">Gred &amp; Bidang Pengkhususan</label>
                    <div id="cidb_group">
                        <!-- Template Item -->
                    ...
                    <tr ng-repeat="item in items" ng-class="item == editingItem && 'editing'">
                        ...
                        <td class="text-center" ng-if="!show">
                            ...
                            <div ng-show="item != editingItem">
                                <button type="button" class="btn btn-info btn-xs" ng-click="edit(item)">
        ...
        @if(isset($vendor) && $vendor->approval_1_id > 0)
                ...
                <table class="clean-table">
                    ...
                    <tbody>
                        <tr ng-repeat="item in items" ng-class="item == editingItem && 'editing'">
                            ...
                            <td class="text-center" ng-if="!show">
                                ...
                                <div ng-show="item != editingItem">
                                    <button type="button" class="btn btn-info btn-xs" ng-click="edit(item)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button>
                                    <button type="button" class="btn btn-danger btn-xs" ng-click="remove($index)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button>
                                </div>
                                <div ng-show="item == editingItem">
                                    <span class="badge badge-warning">Editing</span>
                                </div>
                    ...
                    <tfoot ng-if="!show">
                        <tr ng-keyup="setHasNewItem()" style="background: #f8fafc;">
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-primary btn-xs" ng-click="save()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></button>
                                <button type="button" class="btn btn-default btn-xs" ng-click="clear()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                    ...
                    <tbody>
                        <tr ng-repeat="item in items" ng-class="item == editingItem && 'editing'">
                            ...
                            <td class="text-center" ng-if="!show">
                                ...
                                <div ng-show="item != editingItem"><button type="button" class="btn btn-info btn-xs" ng-click="edit(item)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button><button type="button" class="btn btn-danger btn-xs" ng-click="remove($index)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button></div>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot ng-if="!show"><tr ng-keyup="setHasNewItem()" style="background:#f8fafc;"><td><input class="form-control input-sm" ng-model="newItem.name" type="text"></td><td><input class="form-control input-sm" ng-model="newItem.description" type="text"></td><td><input class="form-control input-sm" ng-model="newItem.by" type="text"></td><td class="text-center"><button type="button" class="btn btn-primary btn-xs" ng-click="save()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></button> <button type="button" class="btn btn-default btn-xs" ng-click="clear()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button></td></tr></tfoot>
                </table>
            </div>
            ...
            <div class="tab-pane" id="vf-assets" ng-controller="ItemController" <?php if(isset($vendor)) { ?> data-remote="{{ asset('vendor/'.$vendor->id.'/assets') }}" <?php } ?> >
                ...
                <table class="clean-table">
                    ...
                    <tfoot ng-if="!show"><tr ng-keyup="setHasNewItem()" style="background:#f8fafc;"><td><input class="form-control input-sm" ng-model="newItem.name" type="text"></td><td><div class="modern-input-group"><div class="addon">RM</div><input class="form-control input-sm" ng-model="newItem.value" type="text"></div></td><td class="text-center"><button type="button" class="btn btn-primary btn-xs" ng-click="save()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></button> <button type="button" class="btn btn-default btn-xs" ng-click="clear()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button></td></tr></tfoot>
                </table>
            </div>
            ...
            <div class="tab-pane" id="vf-projects" ng-controller="ItemController" <?php if(isset($vendor)) { ?> data-remote="{{ asset('vendor/'.$vendor->id.'/projects') }}" <?php } ?> >
                ...
                <table class="clean-table">
                    ...
                    <tfoot ng-if="!show"><tr ng-keyup="setHasNewItem()" style="background:#f8fafc;"><td><input class="form-control input-sm" ng-model="newItem.name" type="text"></td><td><input class="form-control input-sm" ng-model="newItem.customer" type="text"></td><td><input class="form-control input-sm" ng-model="newItem.period" type="text"></td><td><div class="modern-input-group"><div class="addon">RM</div><input class="form-control input-sm" ng-model="newItem.value" type="text"></div></td><td><input ng-model="newItem.done" type="checkbox"></td><td class="text-center"><button type="button" class="btn btn-primary btn-xs" ng-click="save()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></button> <button type="button" class="btn btn-default btn-xs" ng-click="clear()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button></td></tr></tfoot>
                </table>
            </div>
            ...
            <div class="tab-pane" id="vf-products" ng-controller="ItemController" <?php if(isset($vendor)) { ?> data-remote="{{ asset('vendor/'.$vendor->id.'/products') }}" <?php } ?> >
                 ...
                 <table class="clean-table">
                     ...
                     <tfoot ng-if="!show"><tr ng-keyup="setHasNewItem()" style="background:#f8fafc;"><td><input class="form-control input-sm" ng-model="newItem.name" type="text"></td><td><input class="form-control input-sm" ng-model="newItem.description" type="text"></td><td><input class="form-control input-sm" ng-model="newItem.implementations" type="text"></td><td class="text-center"><button type="button" class="btn btn-primary btn-xs" ng-click="save()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></button> <button type="button" class="btn btn-default btn-xs" ng-click="clear()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button></td></tr></tfoot>
                 </table>
            </div>
        @endif
