    	...
    	<div class="tab-content col-lg-10">
             	...
             	<div class="col-md-6">
					...
					<div class="form-group">
                     ...
                     <div class="col-lg-3 col-sm-3">
                        <select class="form-control" name="authorized_capital_currency" id="authorized_capital_currency">
                     ...
                     <div class="col-lg-3 col-sm-3">
                        <select class="form-control" name="paidup_capital_currency" id="paidup_capital_currency">
                        	@foreach(App\Vendor::$currencies as $key => $value)
            ...
            <table class="table table-striped table-bordered table-hover">
               ...
               <tfoot ng-if="!show">
                     ...
                     <td>
                      	<select class="form-control input-xs" name="nat" ng-model="newItem.nationality">
        ...
        <div class="tab-pane" id="vf-directors" ng-controller="ItemController" 
            ...
            <table class="table table-striped table-bordered table-hover">
               ...
               <tfoot ng-if="!show">
                     ...
                     <td>
								<select class="form-control input-xs" name="nat" ng-model="newItem.designation">
