		...
		<table class="table table-bordered table-condensed" id="table-transaction">
			<tbody>
				<tr>
					...
					<td style="width: 80%">
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="text" id="company_name" value="{{ $transaction->vendor->name }}" readonly>
				...
				<tr>
					...
					<td>
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="text" id="payment_type" value="{{ $transaction->method }}" readonly>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="text" id="transaction_date" value="{{ $transaction->transaction_date }}"
								readonly>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="text" id="amount" name="amount" value="{{ $transaction->amount }}"
								readonly>
						</div>
					</td>
				</tr>
					...
					<td>
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="text" id="agency"
								value="{{ $transaction->type == 'purchase' ? $transaction->agency->name : 'SUK Selangor' }}" readonly>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="text" id="name" name="name" value="{{ $refund->name }}" required>
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="tel" id="tel" name="tel" value="{{ $refund->tel }}" required>
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="text" id="bank_acc" name="bank_acc" value="{{ $refund->bank_acc }}"
								required>
						</div>
					</td>
				</tr>
				...
				<tr>
					<td>
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="file" accept="application/pdf" name="application_letter"
				...
				<tr>
					<td>
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="file" accept="application/pdf" name="screenshot_problem"
								id="screenshot_problem">
							<span class="help-block">
								Muat naik fail berkaitan untuk tujuan pengesahan. Hanya fail beformat PDF sahaja.
							</span>
						</div>
