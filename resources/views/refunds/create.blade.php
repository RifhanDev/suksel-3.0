	...
	<form action="{{ route('refunds.store') }}" enctype="multipart/form-data" class="form-horizontal" method="POST">
		...
		<div class="form-group required">
			...
			<div class="col-lg-9 col-sm-9">
				<select class="form-control" id="transaction_id" name="transaction_id" onchange="transactionDetails(this)" required>
				</select>
			</div>
		</div>
		<hr>
					...
					<td>
						<div class="col-lg-12 col-sm-12">
							<input class="form-control" type="file" accept="application/pdf" name="application_letter"
								id="application_letter" required>
