...
<title>Pemulangan Semula Diluluskan Oleh BPM | Tender Online SUK Selangor</title>
<style type="text/css">
...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
            ...
            <tr><td align="left" valign="middle">
              ...
              <table width="115" border="0" cellspacing="0" cellpadding="0" >
                <tr><td align="left" valign="top" class="mob_center">
                  ...
                  <img src="{{ asset('assets/images/header.png') }}" width="300" height="75" alt="Tender Online SUK Selangor" border="0" border="0" style="display: block;" /></font></a>
                </td></tr>
              </table>            
            </td></tr>
  ...
  <tr><td align="center" bgcolor="#ffffff">
    <table width="90%" border="0" cellspacing="0" cellpadding="0">
      <tr><td align="center">
        ...
        <div style="line-height: 44px;">
          ...
          <span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
            Permohonan Pemulangan Semula Diluluskan Oleh BPM
          </span></font>
        </div>
        <!-- padding --><div style="height: 30px; line-height: 30px; font-size: 10px;">&nbsp;</div>
      </td></tr>
              ...
              <tr><td align="center">
                <div style="line-height: 24px;">
                  ...
                  <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                    [{{ $refund_num }}] Adalah dimaklumkan permohonan pemulangan semula telah diluluskan oleh BPM. <br><br>
                    Sila ikuti arahan seterusnya :- <br>
                    Semua penyata, resit, surat dan borang yang lengkap wajib perlu dicetak dan dihantar secara pos / fizikal ke: <br>
                    <b>Bahagian Khidmat Pengurusan,</b> <br>
                    <b>Unit Kewangan, Tingkat 17,</b> <br>
                    <b>Bangunan Sultan Salahuddin Abdul Aziz Shah,</b> <br>
                    <b>40503 Shah Alam,Selangor Darul Ehsan.</b> <br>
                  </span></font>
                </div>
              </td></tr>
            </table>
      ...
      <tr><td align="center">
        <div style="line-height:24px;">
          <a href="{{ route('refunds.show', $refund->id) }}" target="_blank" style="background: #F3565D; font-family: Arial, Helvetica, sans-serif; font-size: 13px; padding: 15px 30px;  text-decoration: none;">
            <font face="Arial, Helvetica, sans-serif; font-size: 13px; text-decoration: none;" size="3" color="#fff">
              Lihat Maklumat Pemulangan Semula
            </font>
          </a>
        </div>
        <!-- padding --><div style="height: 100px; line-height: 100px; font-size: 10px;">&nbsp;</div>
