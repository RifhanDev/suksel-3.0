	...
	<div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4">
		<div class="mb-3 mb-lg-0">
			<h3 class="fw-bold text-dark m-0" style="letter-spacing: -0.5px;">
				Pemulangan Semula{{ isset($subtitle) ? ': ' . $subtitle : '' }}
			</h3>
			<p class="text-muted small m-0">Pengurusan dan semakan permohonan pemulangan semula pembayaran.</p>
		</div>
	</div>
	...
	<div class="content-card p-0">
		<div class="content-card-header p-4 pb-3 border-bottom">
			<div class="d-flex align-items-center gap-3">
				...
				<h3 class="content-card-title" style="font-size: 1rem;">Senarai Pemulangan Semula</h3>
			</div>
		</div>
