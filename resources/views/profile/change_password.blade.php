...
@section('content')
	...
	{!! Former::password('old_password')->label('Kata Laluan Asal')->required() !!}
	{!! Former::password('password')->label('Kata Laluan Baru')->help(
	...
	{!! Former::password('password_confirmation')->label('Sahkan Kata Laluan Baru')->help('Masukan semula kata laluan.')->required() !!}
	<div class="well">
