		...
		<div class="p-4">
			<div class="row g-3">
				...
				<div class="col-12">
					...
					<input class="form-control" id="subject" name="subject" type="text" value="{{ $complaint->subject }}" disabled>
				</div>
				...
				<div class="col-12">
					...
					<input class="form-control" id="email" name="email" type="text" value="{{ $complaint->email }}" disabled>
				</div>

				<!-- Status -->
				<div class="col-md-6">
					<label for="status" class="form-label fw-medium small">Status</label>
					<input class="form-control" id="status" name="status" type="text" value="{{ $complaint->complaintStatus() }}"
						disabled>
				</div>
			...
			@if (App\Models\Complaint::canApprove())
				<div class="d-flex flex-column flex-sm-row gap-2">
					@if ($complaint->status == 0)
						<a href="{{ action('ComplaintController@updateStatus', [$complaint->id, 1]) }}" class="btn-form link-confirm"
						...
						<a href="{{ action('ComplaintController@updateStatus', [$complaint->id, 2]) }}" class="btn-form link-confirm"
				...
				<div class="d-flex flex-wrap gap-2">
					@if ($complaint->status == 0)
						<a href="{{ action('ComplaintController@updateStatus', [$complaint->id, 1]) }}"
							class="btn btn-info link-confirm">
