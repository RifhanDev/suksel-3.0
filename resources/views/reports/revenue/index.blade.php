...
@section('content')
	...
	{!! Former::select('year_start')->label('Mulai Tahun')->options($select_year)->placeholder('Pilih tahun laporan yang ingin dihasilkan...')->required() !!}
	{!! Former::select('year_end')->label('hingga')->options($select_year)->placeholder('Pilih tahun laporan yang ingin dihasilkan...')->required() !!}
	<div class="form-group">
		...
		<div class="col-lg-9">
			...
			<div class="checkbox"><label><input type="checkbox" name="registration" value="1"> Langganan Kontraktor</label>
			</div>
			<div class="checkbox"><label><input type="checkbox" name="renewal" value="1"> Pembaharuan Langganan
					Kontraktor</label></div>
		</div>
	</div>
