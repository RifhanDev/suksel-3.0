...
@section('content')
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4">
        <div>
            <h3 class="fw-bold text-dark m-0" style="letter-spacing: -0.5px;">Laporan Transaksi</h3>
            <p class="text-muted small m-0">Jana laporan transaksi vendor sistem tender online.</p>
        </div>
    </div>
    ...
    <div class="content-card p-4">
        <form action="" method="POST" target="_blank">
            ...
            <div class="mb-3">
                <label for="agency" class="form-label fw-semibold">Agensi</label>
