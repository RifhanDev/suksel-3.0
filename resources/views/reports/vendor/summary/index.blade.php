...
@section('content')
	...
	<form id="tender_summary" class="form-inline">
		<h3 class="tender-title">Laporan Transaksi Syarikat :
			<input class="form-control" id="year_summary" type="text" name="year_summary" style="width:10%;font-weight: bold;"
				autocomplete="off">
		</h3>
	</form>
		...
		<tbody>
			@forelse ($lists as $list)
				<tr>
					...
					<td>
						{{ $list->type == 'purchase' ? strtoupper($list->purchases[0]->tender->name) : 'LANGGANAN SISTEM TENDER ONLINE SELANGOR' }}
					</td>
