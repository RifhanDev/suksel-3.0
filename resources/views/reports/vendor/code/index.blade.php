...
@section('content')
	...
	{!! Former::select('district_id')->id('district_id')->label('Daerah')->options(['-1' => ''] + App\Vendor::$districts)->placeholder('') !!}
		...
		<div class="col-lg-9 col-sm-9">
			<div id="mof_form">
				<div id="mof_form_template">
					<div class="row">
						<div class="col-lg-3">
							<select id="mof_form_#index#_inner_rule" class="mof-code-inner-rule form-control"
								name="mof_codes[#index#][inner_rule]">
						...
						<div class="col-lg-7">
							<select id="mof_form_#index#_codes" class="mof-code-codes form-control selectize"
								name="mof_codes[#index#][codes][]" multiple="multiple">
					...
					<div class="row join-rule">
						<div class="col-lg-3 col-lg-offset-3">
							<select id="mof_form_#index#_join_rule" class="mof-code-join-rule form-control"
								name="mof_codes[#index#][join_rule]">
	...
	{!! Former::select('cidb_grades[]')->id('cidb_grades')->label('Gred CIDB')->options(App\Code::where('type', 'cidb-g')->get()->pluck('label', 'id'))->multiple(true)->placeholder('') !!}
		...
		<div class="col-lg-9 col-sm-9">
			<div id="cidb_form">
				<div id="cidb_form_template">
					<div class="row">
						<div class="col-lg-3">
							<select id="cidb_form_#index#_inner_rule" class="cidb-codes-inner-rule form-control"
								name="cidb_codes[#index#][inner_rule]">
								<option value="and">Kesemua</option>
								<option value="or">Salah Satu</option>
							</select>
						</div>
						...
						<div class="col-lg-7">
							<select id="cidb_form_#index#_codes" class="mof-codes-code form-control selectize"
								name="cidb_codes[#index#][codes][]" multiple="multiple">
					...
					<div class="row join-rule">
						<div class="col-lg-3 col-lg-offset-3">
							<select id="cidb_form_#index#_join_rule" class="cidb-codes-join-rule form-control"
								name="cidb_codes[#index#][join_rule]">
								<option value="and">Dan</option>
								<option value="or">Atau</option>
							</select>
						</div>
	...
	<script type="text/javascript">
		...
		$("#mof_form").sheepIt({
					...
					@if (isset($tender) && $tender->mof_codes)
						data: [
							@foreach ($tender->mof_code_groups as $order => $group)
								{
									'mof_form_#index#_codes': {
										{
											json_encode($group['codes']) !!
										},
				...
				$("#cidb_form").sheepIt({
					...
					selectize_select('#mof_form'); selectize_select('#cidb_form'); $("#cidb_grades").selectize();
	</script>
@endsection
