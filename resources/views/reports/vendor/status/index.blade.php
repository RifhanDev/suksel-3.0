	...
	<table class="table table-bordered">
		...
		<tbody>
			<tr>
				...
				<td>
					<a href="{{ action('ReportVendorStatusController@view', ['view' => 'daftar_belum_lulus']) }}"
						target="_blank">Senarai</a> |
			...
			<tr>
				...
				<td>
					<a href="{{ action('ReportVendorStatusController@view', ['view' => 'lulus_belum_bayar']) }}"
						target="_blank">Senarai</a> |
