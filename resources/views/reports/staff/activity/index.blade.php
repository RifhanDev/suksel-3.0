...
@section('content')
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4">
        <div>
            <h3 class="fw-bold text-dark m-0" style="letter-spacing: -0.5px;">Laporan Aktiviti Pengguna Sistem</h3>
            <p class="text-muted small m-0">Jana laporan aktiviti pengguna sistem tender online.</p>
        </div>
    </div>
