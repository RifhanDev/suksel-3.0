...
<script type="text/javascript">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // =========================
        function buildRow(isFirst, rowspan = 3) {

            if (isFirst) {
                return `
                    <tr class="item-row">
                        <td rowspan="${rowspan}" class="align-top">
                            <input type="text" name="roc_syarikat[]" class="form-control form-control-sm" placeholder="ROC Syarikat">
                        </td>
                        <td>
                            <input type="text"
                            name="no_ic[]"
                        ...
                        <td>
                            <input type="text" name="nama_individu[]" class="form-control form-control-sm" placeholder="Nama Individu">
                        </td>
                    </tr>
                `;
            }
        ...
        modalEl.addEventListener('shown.bs.modal', function () {
            ...
            for (let i = 0; i < totalRows; i++) {
                modalBody.insertAdjacentHTML(
                    "beforeend",
                    buildRow(i === 0, totalRows)
                );
            }
        });

        // =========================
        // SAVE → INSERT AS 1 GROUP ITEM
        // =========================
        document.querySelector('.btn-pilih-standard').addEventListener('click', function () {
            ...
            // =========================
            // ITEM NUMBER (GROUP BASED)
            // =========================
            let itemIndex = mainTableBody.querySelectorAll('tr.group-first').length + 1;
            ...
            mainTableBody.insertAdjacentHTML('beforeend', firstRow);

            // =========================
            // REMAINING ROWS (SUB ROWS)
            // =========================
