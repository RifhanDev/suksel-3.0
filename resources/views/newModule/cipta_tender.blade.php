...
<style>
    ...
    /* ALERT */
    .alert-selangor {
        background-color: rgba(255, 204, 0, 0.1); /* Soft sg-yellow background */
    ...
    /* --- 3. INPUT STYLING (nanti masukkan dalam master) --- */
    .form-label {
        font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;
        color: var(--label-color); margin-bottom: 6px; display: block;
    }
    
    .form-control, .form-select {
        font-size: 0.85rem; padding: 0.55rem 0.85rem;
        border-color: var(--input-border); background-color: var(--input-bg);
        border-radius: 8px; transition: all 0.2s; color: var(--text-dark);
        font-weight: 500;
    }
    ...
    .input-group-text {
        background: #f8fafc; border-color: var(--input-border);
    ...
    .segmented-control label {
        flex: 1; text-align: center; padding: 6px 4px; font-size: 0.75rem; font-weight: 600;
        cursor: pointer; border-radius: 6px; color: #64748b; transition: all 0.2s;
        margin: 0;
    }
    ...
    .section-connector-select-wrapper {
        position: relative;
        display: inline-flex;
        align-items: center;
    }
    ...
    .section-connector-select:hover {
        transform: translateY(-2px);
        box-shadow: 0 6px 16px rgba(196, 30, 58, 0.4);
    }

    .section-connector-select:focus {
        outline: none;
        box-shadow: 0 0 0 4px var(--sg-red-soft), 0 6px 16px rgba(196, 30, 58, 0.4);
    }
            ...
            <div class="p-4">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="kaedah_perolehan">
                            <option selected disabled>Pilih...</option>
                            <option value="tender">Tender</option>
                            <option value="sebut_harga">Sebut Harga</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="kategori_perolehan" required>
                            <option selected disabled>Pilih...</option>
                            <option value="perkhidmatan_bekalan">Perkhidmatan / Bekalan</option>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" name="tajuk_perolehan" rows="2" placeholder="Masukkan tajuk tender/sebut harga..." required></textarea>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        ...
                        <select class="form-select" name="ptj_id" id="ptj-select" required>
                            <option selected disabled>Pilih...</option>
                            <option value="kementerian_kewangan">BAHAGIAN PENTADBIRAN - CAWANGAN KEWANGAN - KEMENTERIAN KEWANGAN</option>
                            <option value="jabatan_pengairan_saliran">JABATAN PENGAIRAN DAN SALIRAN</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control fw-bold" name="no_tender" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Harga Indikatif Jabatan</label>
                        <div class="input-group">
                            <span class="input-group-text">RM</span>
                            <input type="number" class="form-control text-end" name="harga_indikatif" min="0" step="0.01" placeholder="0.00">
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control text-end fw-bold" name="anggaran_jabatan" min="0" step="0.01" placeholder="0.00" required>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="settings-grid-box">
                            ...
                            <div class="d-flex flex-column gap-2 mb-2">
                                <div class="segmented-control">
                                    <input type="radio" name="sumber_peruntukan" id="sp_pem" value="pembangunan" checked>
                                ...
                                <textarea class="form-control d-none" id="sumber_lain_input" name="sumber_lain_text" rows="2" placeholder="Nyatakan..."></textarea>
                            </div>
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="segmented-control">
                                        ...
                                        <input type="radio" name="zon_lokasi" id="z_t" value="0" checked>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="segmented-control">
                                        ...
                                        <input type="radio" name="jawatankuasa" id="jk_t" value="0" checked>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="segmented-control">
                                        ...
                                        <input type="radio" name="lawatan_tapak" id="lt_t" value="0" checked>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="segmented-control">
                                        ...
                                        <input type="radio" name="fizikal" id="pf_t" value="0" checked>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="segmented-control">
                                        ...
                                        <input type="radio" name="terbuka_kepada" id="tk_s" value="semua" checked>
                                ...
                                <div class="condition-row mof-row" data-index="0">
                                    ...
                                    <div class="row-fields">
                                        <div class="field-logic">
                                            ...
                                            <div class="segmented-control">
                                                <input type="radio" name="mof[0][logic_mid]" id="mof0_or" value="OR" checked>
                                ...
                                <div class="d-flex align-items-center justify-content-between p-3 gap-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <select name="section_logic" class="form-select form-select-sm fw-bold text-dark border-secondary bg-light" style="cursor: pointer;">
                                            <option value="AND" selected>DAN</option>
                                    ...
                                    <div class="row-fields cidb-fields">
                                        ...
                                        <div class="cidb-row-bottom">
                                            <div class="field-logic">
                                                <label class="form-label">Hubungan</label>
                                                <div class="segmented-control">
                                                    <input type="radio" name="cidb[0][logic_mid]" id="cidb0_and" value="AND" checked>
