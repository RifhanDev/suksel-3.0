        ...
        <div class="bg-white rounded overflow-hidden mb-4">
            <div class="table-responsive">
                <table class="table project-table mb-0">
                    ...
                    <tbody>
                        @forelse($tender as $t)
                        <tr class="teknikal-row-link" data-href="{{ route('penilaianTeknikal.show', $t['no']) }}">
                            <td><a href="{{ route('penilaianTeknikal.show', $t['no']) }}" class="text-decoration-none"><span class="tender-number">{{ $t['no'] }}</span></a></td>
