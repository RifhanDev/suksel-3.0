...
<div id="step3-main">
    ...
    <div class="mb-3" id="pengesyoran-section">
        <!-- Pengesyoran -->
        <div class="card-title card-title-grey">PENGESYORAN</div>
        <div id="pengesyoran-list">
...
Dengan ini, JPT mengesyorkan XX (bil) untuk melaksanakan (NAMA PROJEK) untuk dibawa ke mesyuarat Jawatankuasa Sebut Harga PSU(K) berdasarkan justifikasi seperti berikut:
        ...
        <div class="d-flex justify-content-end">
            <button id="btnTambahPengesyoran" class="btn btn-success">Tambah</button>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-end gap-2">
        ...
        <button id="btnStep3Hantar" class="btn btn-primary">Hantar</button>
    </div>

</div> {{-- /#step3-main --}}

{{-- Success state after Hantar --}}
<div id="step3-success" class="d-none" style="min-height:400px;display:flex;align-items:center;justify-content:center;">
    <div class="card shadow-sm text-center" style="max-width:480px;">
        <div class="card-body py-5">
            ...
            <button type="button" id="btnStep3CloseSuccess" class="btn btn-primary">Tutup</button>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const mainWrap = document.getElementById('step3-main');
        const successWrap = document.getElementById('step3-success');
        const btnClose = document.getElementById('btnStep3CloseSuccess');
