        ...
        <div class="d-flex flex-column flex-md-row gap-3 align-items-end mb-4 flex-wrap">
            <div class="w-100 flex-md-fill" style="min-width: 180px;">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control border-start-0" id="searchTenderNo" placeholder="No. Tender">
                </div>
            </div>
            ...
            <div class="w-100 flex-md-fill" style="min-width: 180px;">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control border-start-0" id="searchTajuk" placeholder="Tajuk Perolehan">
                </div>
            </div>
            ...
            <div class="w-100 flex-md-fill" style="min-width: 180px;">
                ...
                <div class="input-group">
                    ...
                    <input type="date" class="form-control border-start-0" id="searchTarikh">
                </div>
            </div>
        ...
        <div class="bg-white rounded overflow-hidden mb-4">
            <div class="table-responsive">
                <table class="table project-table mb-0">
                    ...
                    <tbody>
                        <tr class="cutoff-row-link" style="cursor: pointer;" data-href="{{ route('cutOff.show', 'QT210000000023741') }}">
                            <td><a href="{{ route('cutOff.show', 'QT210000000023741') }}" class="text-decoration-none"><span class="tender-number">QT210000000023741</span></a></td>
                        ...
                        <tr class="cutoff-row-link" style="cursor: pointer;" data-href="{{ route('cutOff.show', 'QT210000000023740') }}">
                            <td><a href="{{ route('cutOff.show', 'QT210000000023740') }}" class="text-decoration-none"><span class="tender-number">QT210000000023740</span></a></td>
...
<script>
document.querySelectorAll('.cutoff-row-link').forEach(function(row) {
