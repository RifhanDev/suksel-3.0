...
@section('content')
    ...
    <div class="stepper-wrapper" data-step="1" id="stepper-wrapper">
        ...
        <div class="stepper-item" id="step2-indicator">
            ...
            <div class="step-name">Maklumat BQ</div>
        </div>
    ...
    <form id="createProjekForm"
        ...
        <div class="modern-card">
            ...
            <div id="step2-content" class="d-none">
                ...
                <div class="p-4">
                    <h6 class="fw-bold text-dark mb-3">Dokumen BQ</h6>

                    <!-- Upload Zone (our style) — single file -->
                    <label class="upload-zone w-100" id="upload-zone-bq" for="input-dokumen-bq">
                        ...
                        <span class="upload-zone-label">Klik atau seret fail BQ ke sini untuk muat naik</span>
                        <span class="upload-zone-sub">PDF, Word, Excel — saiz maksimum 10 MB · satu fail sahaja</span>
                        <input type="file" id="input-dokumen-bq" name="dokumen_bq" hidden
                    ...
                    <div id="bq-file-preview" class="d-none mt-3">
                        <div class="d-flex align-items-center gap-3 border rounded-3 bg-white p-3"
                            ...
                            <span class="file-chip-ext" id="bq-file-ext"
                                style="width:40px;height:40px;font-size:0.62rem;">file</span>
                            ...
                            <button type="button" class="file-chip-remove flex-shrink-0" id="bq-file-remove"
                                title="Buang fail" style="width:24px;height:24px;">
            ...
            <div class="bg-light p-4 border-top d-flex justify-content-between align-items-center">
                ...
                <div class="ms-auto d-flex gap-2">
                    ...
                    <button type="submit" class="btn-form btn-form-primary d-none" id="btn-submit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        $(document).ready(function() {
            ...
            (function() {
                ...
                function showFile(file) {
                    ...
                    $('#bq-file-ext').attr('class', 'file-chip-ext ext-' + ext).text(ext);
                    $('#bq-file-original').text(file.name);
                    $('#bq-file-size').text(formatBytes(file.size));
                    // Pre-fill name only if user hasn't typed a custom one
                    if (!$('#bq-file-nama').val()) $('#bq-file-nama').val(stripExt(file.name));
                ...
                // Remove
                $('#bq-file-remove').on('click', function() {
                    bqInput.value = '';
                    $('#bq-file-nama').val('');
                    $preview.addClass('d-none');
                });

                // Drag-and-drop (enforce single file)
                var zoneEl = $zone[0];
