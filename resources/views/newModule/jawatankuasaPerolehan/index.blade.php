                ...
                <table id="tbl-perolehan" class="table table-hover align-middle mb-0 w-100">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="text-uppercase text-muted small fw-bold py-3" width="140px">Tarikh Serahan</th>
                            <th class="text-uppercase text-muted small fw-bold py-3" width="140px">Tempoh Sah Laku</th>
                            <th class="text-uppercase text-muted small fw-bold py-3" width="130px">Status</th>
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            const formUrl = "{{ route('jawatankuasaPerolehan.form') }}";
            ...
            const dummyData = [
                {
                    ...
                    tarikh_serahan: '15/04/2025',
                    tempoh_sah_laku:'90 Hari (Sehingga 14/07/2025)',
                    status:         '<div class="text-center"><span class="d-inline-flex align-items-center gap-1 px-2 py-1 rounded-pill small fw-semibold" style="background:#fef3c7;color:#b45309;">' + svgClock + ' Dalam Proses</span></div>',
                    tindakan:       ` <div class="d-flex gap-2 justify-content-center">
                                            <a href="${formUrl}" class="btn btn-sm btn-primary rounded-8 px-3">
                                                Teruskan
                                            </a>
                                        </div>
                                    `
            ...
            var DT = $('#tbl-perolehan').DataTable({
                ...
                columns: [
                    ...
                    { data: 'tindakan', orderable: false, searchable: false, className: 'text-center' }
                ],
                columnDefs: [
                    {
                        targets: 4,
            ...
            $('#btn_apply_filter').on('click', function () {
                ...
                // Client-side search using DataTables built-in (replace with AJAX when backend is ready)
