...
<div class="container-fluid mt-2">
    ...
    {{-- Top strip (optional – ikut layout master kalau dah ada, boleh buang) --}}
    <div class="top-strip">
    ...
    <div class="d-flex justify-content-end mt-4">
        <button type="button" class="btn-simpan" onclick="showB7aSerupaSuccess()">Simpan</button>
    </div>

</div>

{{-- MODAL SUCCESS --}}
<div class="modal fade" id="b7aSerupaSuccessModal" tabindex="-1" aria-hidden="true">
...
<script>
    function showB7aSerupaSuccess(){
        const modal = new bootstrap.Modal(document.getElementById('b7aSerupaSuccessModal'));
        modal.show();
    }
</script>
@endsection
