...
@section('content')
                    ...
                    <div id="penyata_bank_bulan_rows_wrapper">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-2 penyata-bank-bulan-item" data-ym="{{ $pbRow->format('Y-m') }}">
                            ...
                            <input type="text" class="form-control form-control-sm text-end amount-input penyata-bank-bulan-input"
                                ...
                                data-bulan="{{ $pbRow->month }}" data-tahun="{{ $pbRow->year }}" placeholder="0.00" readonly disabled>
                        </div>
                        @endforeach
                    </div>
                </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            ...
            <button type="button" class="btn-form btn-form-success btn-simpan-penyata">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
$(document).ready(function () {
    ...
    $('.btn-simpan-penyata').on('click', function () {
        successModal.show();
    });
