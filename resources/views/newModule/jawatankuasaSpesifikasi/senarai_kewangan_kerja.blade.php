...
@section('content')
    ...
    <form id="form-senarai-kewangan-kerja" action="{{ route('jawatankuasa.simpanSenaraiKewanganKerja') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    <div class="p-3 rounded-2 h-100" style="background: #fafbfc; border: 1px solid #f1f5f9;">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <input type="number" id="input-penilaian" name="input_penilaian" class="form-control form-control-sm text-center fw-semibold" style="max-width: 80px; font-size: 1rem;" placeholder="0" min="0">
