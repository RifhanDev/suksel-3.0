					...
					<tbody>
                         <tr>
                            ...
                            <td class="text-center">
                                 <a href="{{ route('senaraiTeknikal') }}" class="btn btn-sm btn-warning text-white" title="Senarai Semak Teknikal">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button title="Tender" type="button" class="btn btn-sm btn-info text-white" disabled>
