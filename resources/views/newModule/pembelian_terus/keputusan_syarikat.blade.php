    ...
    <div class="card-body p-4">
        ...
        <nav aria-label="breadcrumb" class="py-2 mb-3">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Keputusan Syarikat</li>
            </ol>
        </nav>
                ...
                <table class="table project-table mb-0">
                    ...
                    <tbody id="projectTableBody">
                        <tr data-tender="QT210000000023741" data-tajuk="BEKALAN BARANGAN PERSEKOLAHAN" data-tarikh="3/3/2024">
                            <td>
                                <a class="text-decoration-none" href="{{ route('pembelianTerus.keputusanSyarikatDetails', 'QT210000000023741') }}">
                        ...
                        <tr data-tender="QT210000000023740" data-tajuk="TAJUK PEROLEHAN 1" data-tarikh="2/2/2024">
                            <td>
                                <a class="text-decoration-none" href="{{ route('pembelianTerus.keputusanSyarikatDetails', 'QT210000000023740') }}">
