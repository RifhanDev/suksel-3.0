...
@section('content')
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-start align-items-start align-items-lg-center mb-4">
        <div>
            ...
            <p class="text-muted small m-0">Paparan senarai projek yang menunggu keputusan akhir syarikat.</p>
        </div>
    </div>
    ...
    <div class="content-card p-0">
        <div class="content-card-header">
            <div class="d-flex align-items-center gap-3">
                ...
                <h3 class="content-card-title" style="font-size: 1rem;">Senarai Keputusan Syarikat</h3>
            </div>
        </div>

        <div class="content-card-body p-2">
            <div class="table-responsive">
                <table id="tbl-keputusan" class="table table-hover align-middle mb-0 w-100">
                        ...
                        @foreach ($projects as $project)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge-status badge-status-warning">Menunggu Keputusan</span>
                                </td>
                                <td class="text-center pe-4">
                                    <a href="{{ route('pembelianTerus.keputusanSyarikatDetails', $project->id) }}"
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var DT = $('#tbl-keputusan').DataTable({
                searching: true,
                columnDefs: [
