    ...
    <div class="content-card p-0">
        ...
        <div class="content-card-body p-2">
            <div class="table-responsive">
                <table id="tbl-cut-off" class="table table-hover align-middle mb-0 w-100">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="text-uppercase text-center text-muted small fw-bold py-3" width="160px">Status</th>
                        ...
                        @foreach ($projects as $project)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge-status badge-status-warning">Menunggu Cut Off</span>
                                </td>
                                <td class="text-center pe-4">
                                    <a href="{{ route('pembelianTerus.cutOffDetails', $project->id) }}"
