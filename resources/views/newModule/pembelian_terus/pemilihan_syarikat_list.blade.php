...
@section('content')
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-start align-items-start align-items-lg-center mb-4">
        <div>
            ...
            <p class="text-muted small m-0">Paparan senarai projek yang menunggu proses pemilihan syarikat.</p>
        </div>
    </div>
    ...
    <div class="content-card p-0">
        <div class="content-card-header">
            <div class="d-flex align-items-center gap-3">
                ...
                <h3 class="content-card-title" style="font-size: 1rem;">Senarai Pemilihan Syarikat</h3>
            </div>
        </div>

        <div class="content-card-body p-2">
            <div class="table-responsive">
                <table id="tbl-pemilihan" class="table table-hover align-middle mb-0 w-100">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="text-uppercase text-center text-muted small fw-bold py-3" width="170px">Status</th>
                        ...
                        @foreach ($projects as $project)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge-status badge-status-warning">Menunggu Pemilihan</span>
                                </td>
                                <td class="text-center pe-4">
                                    <a href="{{ route('pembelianTerus.pemilihanSyarikatDetails', $project->id) }}"
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var DT = $('#tbl-pemilihan').DataTable({
                searching: true,
                columnDefs: [
