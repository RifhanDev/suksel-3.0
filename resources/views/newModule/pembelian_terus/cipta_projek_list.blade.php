...
@section('content')
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-start align-items-start align-items-lg-center mb-4">
        <div>
            <h3 class="fw-bold text-dark m-0" style="letter-spacing: -0.5px;">Senarai Projek Untuk Pembelian Terus</h3>
    ...
    <div class="content-card p-0">
        <div class="content-card-header">
            ...
            <a href="{{ route('pembelianTerus.create') }}" class="btn-form btn-form-create">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @elseif ($project->status === 'published')
                                        <span class="badge-status badge-status-success">Diterbitkan</span>
                                    @else
                                        <span class="badge-status badge-status-success">{{ ucfirst($project->status) }}</span>
                                    @endif
                                </td>
                                <td class="text-center pe-4">
                                    @if ($project->status === 'draft')
                                        <a href="{{ route('pembelianTerus.edit', $project->id) }}"
