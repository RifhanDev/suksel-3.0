...
@section('content')
	...
	<div class="row">
					...
					<div id="MainMenu">
						<div class="list-group panel">
							...
							<div class="collapse" id="syarikat">
								...
								<a href="{{ asset('manuals/kemaskini_emel') }}" class="list-group-item">Kemaskini Alamat emel atau No pendaftaran
									syarikat</a>
							...
							@if ($user->ability(['Admin'], ['Vendor:approve']))
								...
								<div class="collapse" id="umum">
									<a href="{{ action('ManualsController@show', 'pengesahan_pendaftaran') }}" class="list-group-item">Pegesahan
										Pendaftaran</a>
									<a href="{{ action('ManualsController@show', 'pengesahan_kemaskini') }}" class="list-group-item">Pegesahan
										Pemintaan Kemaskini</a>
								</div>
							@endif
							<!-- AGENCY USER -->
								...
								<div class="collapse" id="aadmin">
									@if ($user->ability(['Admin'], []))
										<a href="{{ action('ManualsController@show', 'senarai_hitam_admin') }}" class="list-group-item">TAMBAH SENARAI
											HITAM</a>
										<a href="{{ action('ManualsController@show', 'senarai_hitam_batal') }}" class="list-group-item">BATAL SENARAI
											HITAM</a>
									@endif
									<a href="{{ action('ManualsController@show', 'senarai_hitam') }}" class="list-group-item">PAPAR SENARAI
										HITAM</a>
		...
		<a href="javascript:window.print()" class="btn btn-info btn-lg hidden-print"><span
				class="glyphicon glyphicon-print"></span> Cetak Manual Ini</a>
		<br><br>
