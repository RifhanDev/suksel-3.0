...
@section('content')
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4">
        <div class="mb-3 mb-lg-0">
            <h3 class="fw-bold text-dark m-0" style="letter-spacing: -0.5px;">Kemaskini Templat Penolakan</h3>
            <p class="text-muted small m-0">Kemaskini maklumat templat penolakan di bawah.</p>
        </div>
    </div>

    <form action="{{ url('reject-template/' . $template->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="content-card">
            ...
            <div class="d-flex justify-content-between align-items-center p-4 border-top bg-light">
                <a href="{{ asset('reject-template') }}" class="btn-form btn-form-secondary">
