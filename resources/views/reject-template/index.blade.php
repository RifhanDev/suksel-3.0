...
<div class="stats-card mb-4">
    <div class="stats-card-header">
        <h3 class="stats-card-title">
            ...
            Maklumat Templat Penolakan
        </h3>
        <a href="{{ asset('reject-template/create') }}" class="btn btn-selangor d-flex align-items-center gap-2 shadow-sm">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
            Tambah Templat Penolakan Baru
        </a>
    </div>
    <div class="card-body p-2">
        <div class="table-responsive">
            <table data-path="/reject-template" class="DT-index table table-modern w-100 mb-0">
                <thead>
                    <tr>
                        <th width="20%">Tajuk</th>
                        <th>Kandungan</th>
                        <th width="12%">Digunapakai</th>
