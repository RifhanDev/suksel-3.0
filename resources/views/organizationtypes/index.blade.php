...
<div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4">
    <div class="mb-3 mb-lg-0">
        ...
        <p class="text-muted small m-0">Pengurusan kategori agensi Sistem e-Perolehan Selangor.</p>
    </div>
...
<div class="stats-card mb-4">
    <div class="stats-card-header">
        <h3 class="stats-card-title">
            ...
            Senarai Kategori Agensi
        </h3>
        @if (App\OrganizationType::canCreate())
            <a href="{{ route('organizationtypes.create') }}" class="btn btn-selangor d-flex align-items-center gap-2 shadow-sm">
    ...
    <div class="card-body p-2">
        <div class="table-responsive">
            <table data-path="/organizationtypes" class="DT-index table table-modern w-100 mb-0">
                <thead>
                    <tr>
                        <th width="40%">Nama</th>
                        <th width="15%">Susunan</th>
    ...
    $(document).ready(function() {
        $('.DT-index').each(function() {
            ...
            var DT = target.DataTable({
                ...
                aaSorting: [], pageLength: 25, responsive: true, order: [[1, 'asc']]
            });
        });
    });
</script>
