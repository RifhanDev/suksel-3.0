...
@section('content')
	...
	<form class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-lg-9 col-sm-9">
				<input class="form-control" readonly id="mail_password" name="mail_password" type="password" value="********"
					readonly>
			</div>
		</div>
		...
		<div class="well">
			...
			<a href="{{ route('mail-manager.smtp-setting.index') }}" class="btn btn-default pull-right">Senarai Email
				SMTP</a><br />&nbsp;
		</div>
	</form>
@endsection
