...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            // Capture trigger data when modal opens
            $(document).on('click', '.btn-pilih-peringkat', function () {
                _lantikUrl = $(this).data('lantik-url');
                console.log(_lantikUrl);
                $('#modalPilihPeringkat').data('tender-uuid', $(this).data('tender-uuid'));

                // Reset to 1 Peringkat on each open
            ...
            // Teruskan — redirect based on selected peringkat
