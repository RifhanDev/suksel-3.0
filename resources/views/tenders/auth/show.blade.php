                        ...
                        @if (Auth::check() &&
                            ...
                            <li class="nav-item">
                                <a href="{{ asset('tenders/' . $tender->id . '/exceptions') }}" class="nav-link">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="me-1 mb-1" width="20"
                                    ...
                                    <span
                                        class="badge bg-danger ms-2">{{ $tender->exceptions()->where('status', 0)->count() }}</span>
                                </a>
                            </li>
                        @endif
                    </ul>
            ...
            <div class="row stacked-form">
                ...
                <div class="col-lg-3 d-print-none">
                    <div class="tender-side-nav-card">
                        ...
                        @if (count($tender->siteVisits) > 0)
                            <a href="#tf-lawatan" aria-controls="messages" role="tab" data-bs-toggle="tab"
                                class="nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" class="me-1 mb-1" width="18" height="18"
                                    viewBox="0 0 24 24">
                                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        @if (count($tender->table_files) > 0)
                            <a href="#tf-doc1" aria-controls="settings" role="tab" data-bs-toggle="tab"
                                class="nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="18" height="18"
                                    viewBox="0 0 24 24">
                                    <path fill="none" stroke="currentColor" stroke-linecap="round"
                                ...
                                <span
                                    class="badge bg-primary ms-2">{{ $tender->files()->where('public', 1)->count() }}</span>
                            </a>
                        @endif
                        @if (Auth::check() && $tender->canShowFiles(Auth::user()->vendor_id))
                            <a href="#tf-doc2" aria-controls="settings" role="tab" data-bs-toggle="tab"
                                class="nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="18" height="18"
                                    viewBox="0 0 24 24">
                                    <g fill="none" stroke="currentColor" stroke-linecap="round"
                                ...
                                <span
                                    class="badge bg-primary ms-2">{{ $tender->files()->where('public', 0)->count() }}</span>
                            </a>
                        @endif
                        @if (Auth::check() && $tender->canUpdate() && $tender->invitation)
                            <a href="#tf-invites" aria-controls="settings" role="tab" data-bs-toggle="tab"
                                class="nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="18" height="18"
                                    viewBox="0 0 24 24">
                                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        @if (Auth::check() && $tender->canUpdate())
                            <a href="#tf-history" aria-controls="settings" role="tab" data-bs-toggle="tab"
                                class="nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="18" height="18"
                                    viewBox="0 0 24 24">
                                    <g fill="none" stroke="currentColor" stroke-linecap="round"
                        ...
                        @if (auth()->check())
                            @if (
                                ...
                                <a href="#tf-exception" aria-controls="home" role="tab" data-bs-toggle="tab"
                                    class="nav-link">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="18" height="18"
                                        viewBox="0 0 24 24">
                                        <path fill="none" stroke="currentColor" stroke-linecap="round"
                            ...
                            @endif
                        @endif
                        <a href="#tf-officer" aria-controls="home" role="tab" data-bs-toggle="tab"
                            class="nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" class="me-1 mb-1" width="18" height="18"
                                viewBox="0 0 24 24">
                                <path fill="none" stroke="currentColor" stroke-linecap="round"
                ...
                <div class="tab-content col-lg-9">
                    ...
                    <div role="tabpanel" class="tab-pane" id="tf-news">
                        ...
                        @php
                            $list_ralat_news =
                                $tender->news()->wherePublish(1)->orderBy('published_at', 'asc')->get() ?? [];
                        @endphp
                            ...
                            @if (Auth::check() && $tender->canUpdate())
                                <div class="tender-tab-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="my-3">
                                            <label for="notification" class="form-label fw-bold">Kandungan <sup
                                        ...
                                        <input type="hidden" name="tender_id" id="tender_id"
                                            value="{{ $tender->id }}">
                                        <input type="hidden" name="fromTenderRequest" id="fromTenderRequest"
                                            value="999">
				...
				<tbody>
                    ...
                    <div role="tabpanel" class="tab-pane @if (!Session::get('ErrorRequest') and !isset($active_prestasi_tab)) ) active @endif"
                        id="tf-main">
                        <div class="tender-tab-card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    ...
                                    <table class="table tender-info-table mb-0">
                                            ...
                                            <td>
                                                @if ($tender->allow_exception)
                                                    <span class="badge bg-success d-inline-flex align-items-center">
														<svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="16" height="16" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 12a9 9 0 1 0 18 0a9 9 0 1 0-18 0" /><path d="m9 12l2 2l4-4" /></g></svg>
														Ya
													</span>
                                                @else
                                                    <span class="badge bg-danger d-inline-flex align-items-center">
														<svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="16" height="16" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12a9 9 0 1 0 18 0a9 9 0 1 0-18 0m7-4l4 8m-4 0l4-8" /></svg>
														Tidak
													</span>
                                                @endif
                                            </td>
                                        ...
                                        @if ($tender->district_id != null && $tender->district_id > 0)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge bg-info">{{ strtoupper(App\Vendor::$districts[$tender->district_id]) }}
                                                        SAHAJA</span>
                                                </td>
                                            </tr>
                            ...
                            @if (count($tender->mof_codes) > 0)
                                ...
                                @if (count($tender->cidb_grades) > 0)
                                    <div class="text-center my-2">
                                        <span
                                            class="badge bg-success">{{ $tender->mof_cidb_rule == 'or' ? 'ATAU' : 'DAN' }}</span>
                                    </div>
                                @endif
                            @endif
                                        ...
                                        <tbody>
                                            @foreach ($tender->tableFiles as $upload)
                                                <tr>
                                                    ...
                                                    <td>{{ $upload->type }}</td>
                                                    <td>
                                                        <a href="{{ $upload->url }}" class="btn btn-sm btn-selangor"
                                                            download>
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="me-1"
                                                                width="16" height="16" viewBox="0 0 24 24">
                                                                <path fill="none" stroke="currentColor"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                                    d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2M7 11l5 5l5 -5M12 4l0 12" />
                                                            </svg>
                                                            Muat Turun
                                                        </a>
                                                    </td>
                                        ...
                                        <h3 class="card-title">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="18"
                                                ...
                                                <g fill="none" stroke="currentColor" stroke-linecap="round"
                                                    ...
                                                    <path d="M15 3v4a1 1 0 0 0 1 1h4" />
                                                    <path
                                                        d="M18 17h-7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4l5 5v7a2 2 0 0 1-2 2" />
                                                    <path d="M16 17v2a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2" />
                                                </g>
                                            </svg>
                                            Dokumen {{ App\Tender::$types[$tender->type] }}
                                                ...
                                                <tbody>
                                                    @foreach ($tender->tenderFiles as $upload)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ $upload->url }}"
                                                                    class="btn btn-sm btn-selangor" download>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" class="me-1"
                                                                        width="16" height="16"
                                                                        viewBox="0 0 24 24">
                                                                        <path fill="none" stroke="currentColor"
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="18"
                                            ...
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2"
                                                d="M3 7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zm0 0l9 6l9-6" />
                                        </svg>
                                        Senarai Jemputan
                                    </h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-6 mb-2">
                                            <input type="text" id="invite_ids" name="invite_ids"
                                                placeholder="Tambah syarikat" class="form-control">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="18"
                                            ...
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2"
                                                d="M12 8v4l2 2M3.05 11a9 9 0 1 1 .5 4m-.5 5v-5h5" />
                                        </svg>
                                        Sejarah Pengubahan
                                    </h3>
                                </div>
