...
@section('content')
    ...
    <h6 class="review-section-label">Pengalaman Kerja</h6>

    <div class="table-responsive mb-4">
        <table id="tbl-pengalaman-kerja-review" class="table table-bordered table-slate align-middle mb-0 w-100">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center text-muted py-4">Tiada rekod pengalaman kerja.</td>
                    </tr>
                @endforelse
            </tbody>
            @if (count($items))
