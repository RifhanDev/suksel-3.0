                ...
                <div class="card-header">
                    <h3 class="card-title">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                            fill="none" stroke="var(--sg-red, #c41e3a)" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round">
                        ...
                        <table class="table tender-doc-table table-vcenter mb-0">
                            <thead>
                                <tr>
                                    <th style="width: 4%">#</th>
                                    <th>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="13" height="13"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    @if ($tender->hasBriefing())
                                        <th class="text-center" style="width: 10%">
                                            ...
                                            Taklimat
                                            <input type="checkbox" class="form-check-input checker ms-2"
                                    ...
                                    @if (count($tender->siteVisits()->get()) > 0)
                                        ...
                                        @foreach ($tender->siteVisits()->orderBy('id', 'asc')->get() as $visit)
                                            <th class="text-center" style="width: 10%">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="13"
                                    ...
                                    <tr>
                                                ...
                                                @if ($purchase->participate)
                                                    <span class="badge"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="11"
                                                            height="11" viewBox="0 0 24 24" fill="none"
                                        ...
                                        @if (count($tender->siteVisits()->orderBy('id', 'asc')->get()) > 0)
                                            @foreach ($tender->siteVisits()->get() as $visit)
                                                <td class="text-center">
                                                    <input type="checkbox"
                                                        class="form-check-input visit-{{ $visit->id }}"
                                                        name="visits[{{ $visit->id }}][]"
                                        ...
                                        @if ($tender->canShowPrices())
                                            <td>
                                                <input type="text" name="label[{{ $purchase->id }}]"
                                                    value="{{ $purchase->label }}"
                                                    class="form-control form-control-sm">
                                            </td>
                                            <td>
                                                <input type="text" name="price[{{ $purchase->id }}]"
                                        ...
                                        @if ($count_winner > 0)
                                            <td class="text-center">
                                                ...
                                                @if ($purchase->winner == 1)
                                                    <a href="{{ route('index.TenderVendor', $tender) }}"
                                                        class="tender-menu-btn tender-menu-btn-primary">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="13"
                                                            height="13" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
                                        ...
                                        <td class="text-center">
                                            @if ($purchase->participate == 0)
                                                <input type="checkbox" class="form-check-input delete"
                                                    name="delete[]" value="{{ $purchase->id }}">
                                            @else
                                                <span class="badge"
                                                    style="background: #fee2e2; color: #991b1b; font-size: 0.7rem; padding: 0.35em 0.6em; border-radius: 6px;">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-8">
                            <label class="form-label fw-semibold"
                                style="font-size: 0.82rem; color: #334155;">Tambah Syarikat</label>
                            <input type="text" id="vendor_ids" name="vendor_ids"
            ...
            <div class="tender-tab-card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-8">
                            <label class="form-label fw-semibold"
                                style="font-size: 0.82rem; color: #334155;">Pilih Fail CSV</label>
                    ...
                    <div class="mt-3">
                        {!! link_to_route('tenders.template', '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:0.35rem;vertical-align:-2px"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>Templat Dokumen (CSV)', $tender->id, ['class' => 'tender-menu-btn', 'style' => 'background:#1d6f42;color:#fff;border-color:#1d6f42;']) !!}
                    </div>
                    {!! Former::close() !!}
                </div>
            </div>
                ...
                <div class="tender-tab-card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-8">
                                <label class="form-label fw-semibold"
                                    style="font-size: 0.82rem; color: #334155;">Tambah Kebenaran Khas</label>
                                <input type="text" id="exception_id" name="exception_id"
                                    placeholder="Cari nama syarikat...">
                                <small class="text-muted" style="font-size: 0.78rem;">Cari nama syarikat yang ingin
