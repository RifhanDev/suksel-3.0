    ...
    <div class="tender-menu-top">
        ...
        <div class="d-flex align-items-center gap-2">
            @if (Route::currentRouteAction() == 'TendersController@vendors')
                <a href="{{ asset('tenders/' . $tender->id . '/vendors/print') }}"
                    class="tender-menu-btn tender-menu-btn-ghost" target="_new">
        ...
        <div class="tender-menu-bottom">
            ...
            <div class="tender-status-badges">
                ...
                @if ($tender->publish_winner)
                    <span class="badge bg-success d-inline-flex align-items-center" style="background: linear-gradient(135deg, #f59e0b, #d97706) !important;">
                        <svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="13" height="13" viewBox="0 0 24 24">
                            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2"
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="btn-group">
                    <button type="button" class="tender-menu-btn tender-menu-btn-ghost dropdown-toggle"
                                    ...
                                    <a class="dropdown-item publish-tender" href="{{ asset('tenders/' . $tender->id . '/publish') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="me-2" width="15" height="15" viewBox="0 0 24 24">
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M5 12l5 5l10 -10" />
                                        </svg>
                                        Siar Tender
                                    </a>
                                </li>
                            ...
                            @if ($tender->canCancel() && $tender->approver_id)
                                <li>
                                    <a class="dropdown-item text-danger" href="{{ asset('tenders/' . $tender->id . '/cancel') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="me-2" width="15" height="15" viewBox="0 0 24 24">
                                            <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2" d="M18 6l-12 12M6 6l12 12" />
                                        </svg>
                                        Batal Siar
                                    </a>
                                </li>
