                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach ($tender->mof_code_groups as $order => $data)
                                                {!! implode('<br>' . App\VendorCode::$rule[$data['inner_rule']] . '<br>', tender_vendor_codes($data['codes'], null)) !!}
                                                @if ($order != $max_count)
                                    ...
                                    <tbody>
                                        @foreach ($tender->tableFiles as $upload)
                                            <tr style="border-color:#e5e7eb;">
                                                ...
                                                <td>{{ $upload->size }}</td>
                                                <td>{{ $upload->type }}</td>
                                                <td class="pe-4 text-center"><a href="{{ $upload->url }}" class="btn btn-sm btn-primary px-3" download>Muat Turun</a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        @foreach ($list_ralat_news as $news)
                                            <tr style="border-color:#e5e7eb;">
                                                ...
                                                <td>{{ $news->title }}</td>
                                                <td class="pe-4 text-center"><a href="{{ route('news.show', $news->id) }}" class="btn btn-sm btn-primary px-3">Selanjutnya</a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
