<?php $tender = App\Tender::find($tender_id); $vendor = App\Vendor::find($vendor_id); ?>
<!DOCTYPE HTML>
<html>
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>Anggaran Tender / Sebut Harga Layak | Tender Online SUK Selangor</title>
    <style type="text/css">
                          ...
                          <tr><td align="left" valign="middle">
                            ...
                            <table width="115" border="0" cellspacing="0" cellpadding="0" >
                              <tr><td align="left" valign="top" class="mob_center">
                                <a href="{{ asset('/') }}" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
                                  <img src="{{ asset('assets/images/header.png') }}" height="75" alt="Tender Online SUK Selangor" border="0" border="0" style="display: block;" />
                                </a>
                              </td></tr>
                            </table>
                          </td></tr>
                        ...
                        <tr><td align="center">
                          <div style="line-height: 24px;">
                            <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                              Anda dijemput untuk melihat tender / sebut harga berikut<br><br>
                              {{ $tender->name }}
                            </span>
                          </div>
                        </td></tr>
