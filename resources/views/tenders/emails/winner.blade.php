...
<title>Pengumuman Penender Berjaya | Tender Online SUK Selangor</title>
<style type="text/css">
...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
  ...
  <tr><td align="center" bgcolor="#ffffff">
    <table width="90%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr><td align="center">
                <div style="line-height: 24px;">
                  ...
                  <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                    Adalah dimaklumkan bahawa pemenang bagi tender berikut telah diumumkan<br><br>
                    {{ $tender->name }}
                  </span></font>
                </div>
              </td></tr>
      ...
      <tr><td align="center">
        <div style="line-height:24px;">
          <a href="{{ route('tenders.vendors', $tender->id) }}" target="_blank" style="background: #F3565D; font-family: Arial, Helvetica, sans-serif; font-size: 13px; padding: 15px 30px;  text-decoration: none;">
