...
<title>Makluman / Ralat | Tender Online SUK Selangor</title>
<style type="text/css">
...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
  ...
  <tr><td align="center" bgcolor="#ffffff">
    <table width="90%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr><td align="center">
                <div style="line-height: 24px;">
                  ...
                  <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                    Dimaklumkan terdapat makluman / ralat bagi tender berikut<br><br>
                    {{ $tender->name }}
                  </span></font>
                </div>
              </td></tr>
      ...
      <tr><td align="center">
        <div style="line-height:24px;">
          <a href="{{ route('news.show', $news->id) }}" target="_blank" style="background: #F3565D; font-family: Arial, Helvetica, sans-serif; font-size: 13px; padding: 15px 30px;  text-decoration: none;">
            <font face="Arial, Helvetica, sans-serif; font-size: 13px; text-decoration: none;" size="3" color="#fff">
              Lihat Maklumat / Ralat
            </font>
          </a>
        </div>
        <!-- padding --><div style="height: 100px; line-height: 100px; font-size: 10px;">&nbsp;</div>
