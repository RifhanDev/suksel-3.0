...
@section('content')
	...
	<div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4">
		<div class="mb-3 mb-lg-0">
			<h3 class="fw-bold text-dark m-0" style="letter-spacing: -0.5px;">Senarai Pertanyaan Tidak Wujud</h3>
			<p class="text-muted small m-0">Paparan senarai pertanyaan pengguna yang tidak wujud dalam sistem ChatBot.</p>
		</div>
	</div>
	...
	<div class="content-card p-0">
		<div class="content-card-header p-4 pb-3 border-bottom">
			<div class="d-flex align-items-center gap-3">
				...
				<h3 class="content-card-title" style="font-size: 1rem;">Senarai Pertanyaan</h3>
			</div>
		</div>
				...
				<table class="DT-index table table-hover align-middle mb-0 w-100">
					<thead class="bg-light">
						<tr>
							...
							<th class="text-uppercase text-muted small fw-bold py-3">Pertanyaan</th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
