...
@section('content')
	...
	<div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4">
		<div class="mb-3 mb-lg-0">
			<h3 class="fw-bold text-dark m-0" style="letter-spacing: -0.5px;">Senarai Soalan ChatBot</h3>
			<p class="text-muted small m-0">Pengurusan soalan dan jawapan untuk sistem ChatBot.</p>
		</div>
		@if (App\Models\Faq::canCreate())
			<div>
				<a href="{{ route('chatbot-manager.question.create') }}" class="btn-form btn-form-create d-flex align-items-center gap-2">
	...
	<div class="content-card p-0">
		<div class="content-card-header p-4 pb-3 border-bottom">
			<div class="d-flex align-items-center gap-3">
				...
				<h3 class="content-card-title" style="font-size: 1rem;">Senarai Soalan</h3>
			</div>
		</div>
				...
				<table class="DT-index table table-hover align-middle mb-0 w-100">
					<thead class="bg-light">
						<tr>
							...
							<th class="text-uppercase text-muted small fw-bold py-3">Jawapan</th>
