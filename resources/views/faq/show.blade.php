	...
	<form class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-lg-9 col-sm-9">
				<input class="form-control" required="" id="question" name="question" type="text" value="{{ $data->question }}"
					readonly>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9 col-sm-9">
				<input class="form-control" required="" id="answer" name="answer" type="text" value="{{ $data->answer }}"
					readonly>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9 col-sm-9">
				<div id="require_input_text_div" class="form-group form-check pl-4">
					<input type="checkbox" class="form-check-input" id="require_input_text" value="1"
		...
		<div class="form-group">
			...
			<div class="col-lg-9 col-sm-9">
				<div id="require_input_attachment_div" class="form-group form-check pl-4">
					<input type="checkbox" class="form-check-input" id="require_input_attachment" value="1"
				...
				<span for="require_input_attachment_div">**Nota: Penanya perlu memuatnaik gambar sebagai lampiran (Satu Gambar
					sahaja)</span>
			</div>
		</div>
		...
		<div class="well">
			<a href="{{ route('chatbot-manager.question.edit', ['question' => $data->enc_id]) }}"
				class="btn btn-primary pull-left">Kemaskini</a>
			<a href="{{ route('chatbot-manager.question.index') }}" class="btn btn-default pull-right">Senarai Soalan
				ChatBot</a><br />&nbsp;
		</div>
	</form>
@endsection
