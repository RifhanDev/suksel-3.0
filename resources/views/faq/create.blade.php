...
@section('content')
	...
	<form action="{{ route('chatbot-manager.question.store') }}" method="POST" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-lg-9 col-sm-9">
				<div id="require_input_text_div" class="form-group form-check pl-4">
					<input type="checkbox" class="form-check-input" id="require_input_text" name="require_input_text" value="1"
		...
		<div class="form-group">
			...
			<div class="col-lg-9 col-sm-9">
				<div id="require_input_attachment_div" class="form-group form-check pl-4">
					<input type="checkbox" class="form-check-input" id="require_input_attachment" name="require_input_attachment"
						value="1" {{ ($data->require_input_attachment ?? 0) == '1' ? 'checked' : '' }}>
		...
		<div class="well">
			...
			<a href="{{ route('chatbot-manager.question.index') }}" class="btn btn-default pull-right">Senarai Kategori Soalan
				ChatBot</a>
		</div>
	</form>
