...
<style>
    ...
    .header-pretitle {
        font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; color: var(--sg-red); margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.5rem;
    }
    .header-pretitle::before { content: ''; display: block; width: 20px; height: 2px; background: var(--sg-yellow); }

    .header-title {
        font-family: var(--font-display); font-weight: 800; font-size: 1.75rem; color: #111827; margin: 0; line-height: 1.1;
    }
    ...
    .header-icon-box {
        ...
        box-shadow: 0 15px 35px rgba(0,0,0,0.1); color: var(--sg-red);
    ...
    .help-card::after {
        ...
        background: var(--sg-red); transform: scaleX(0); transform-origin: left; transition: transform 0.3s ease;
    }
    .help-card:hover::after { transform: scaleX(1); }

    .help-title {
        font-weight: 700; font-size: 1.1rem; color: #1f2937; margin-bottom: 0.5rem;
        display: flex; align-items: center; justify-content: space-between;
    }

    .help-count {
        background: #fef2f2; color: var(--sg-red); font-size: 0.7rem; font-weight: 700;
        padding: 2px 8px; border-radius: 50px;
    }

    .help-desc {
        font-size: 0.85rem; color: #6b7280; line-height: 1.5; margin: 0;
    }

    /* Empty State */
    .empty-state-modern {
        text-align: center; padding: 4rem 2rem; background: white; border-radius: var(--radius-lg); border: 1px dashed #e5e7eb;
    }
    ...
    .sidebar-title {
        font-size: 0.95rem; font-weight: 800; color: #111827; margin: 0;
        display: flex; align-items: center; gap: 0.5rem;
    }

    /* News Item */
    .news-item-sidebar {
        padding: 1rem; border-bottom: 1px solid #f3f4f6; display: flex; gap: 0.75rem; text-decoration: none; transition: background 0.2s;
    }
    .news-item-sidebar:hover { background: #fef2f2; }
    
    .news-date-small {
        background: #f9fafb; border: 1px solid #e5e7eb; border-radius: var(--radius-sm);
        min-width: 44px; height: 44px; display: flex; flex-direction: column; align-items: center; justify-content: center; line-height: 1;
    }
    ...
    .news-item-sidebar:hover .news-date-small .day, .news-item-sidebar:hover .news-date-small .month { color: white; }
    ...
    <div class="col-lg-9">
        ...
        <form action="{{ action('HelpsController@search') }}" method="GET">
            ...
            <div class="search-card">
                ...
                <input type="text" name="q" class="search-input" placeholder="Carian topik bantuan atau soalan lazim..." value="{{ request('q') }}">
        ...
        @if (count($categories) == 0)
            <div class="empty-state-modern">
                <div class="text-muted mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#e5e7eb" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 19a9 9 0 0 1 9 0a9 9 0 0 1 9 0" /><path d="M3 6a9 9 0 0 1 9 0a9 9 0 0 1 9 0" /><path d="M3 6v13" /><path d="M12 6v13" /><path d="M21 6v13" /></svg>
                </div>
