			...
			<div class="row stacked-form">
				<div class="col-lg-2">
					<ul class="nav nav-pills nav-stacked">
						...
						<li><a href="#db-docs" data-toggle="pill">Dokumen Dibeli <span class="badge">{{ count($purchases) }}</a></li>
						<li><a href="#db-invites" data-toggle="pill">Tender Terhad <span class="badge">{{ count($invites) }}</a></li>
									...
									@foreach ($purchases as $purchase)
										<tr>
											...
											<td>
												...
												<a href="{{ asset('tenders/' . $purchase->tender_id) }}#tf-doc2" target="_blank"><i class="icon-list"> Muat
														Turun</i></a>
											</td>
										</tr>
									@endforeach
									...
									@foreach ($invites as $invite)
										<tr>
											<td>
												...
												<a href="{{ asset('tenders/' . $invite->tender->id) }}">{{ $invite->tender->name }}</a>
											</td>
					...
					<div class="tab-pane" id="db-refund">
						<div class="alert alert-info">
							...
							<ol>
								...
								<li>Sila <b>tukar</b> kandungan dokumen tersebut yang berwarna <span style="color: red;">merah</span> dengan
									maklumat pemohon dan <b>hitamkan</b> semula</li>
								<li>Selepas permohonan diluluskan oleh BPM, <span style="text-decoration: underline">semua penyata, resit, surat
										dan borang yang lengkap wajib perlu dicetak dan dihantar secara pos / fizikal</span> ke:
									<br>
									<b>Bahagian Khidmat Pengurusan,<br>Unit Kewangan, TIngkat 17,<br>Bangunan Sultan Salahuddin Abdul Aziz
										Shah,<br>40503 Shah Alam,Selangor Darul Ehsan</b>
								</li>
							</ol>
						</div>
						<a href="{{ route('refunds.create') }}" type="button" class="btn btn-primary ">Permohonan Baru</a>
						<a download href="{{ asset('file/Template Surat Permohonan Pelanggan 2022.docx') }}" type="button"
							class="btn btn-warning ">Templat Surat Permohonan</a>
						<hr>
