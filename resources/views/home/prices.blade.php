...
@section('styles')
	<style>
		...
		.nav-modern-tabs .nav-link:hover {
			color: #1f2937;
		}
		...
		.news-item-sidebar:hover .news-date-small {
			background: var(--sg-red);
			border-color: var(--sg-red);
		}

		.news-item-sidebar:hover .news-date-small .day,
		.news-item-sidebar:hover .news-date-small .month {
			color: white;
		}
	</style>
@endsection
						...
						<li class="nav-item">
							<a href="{{ action('HomeController@prices', ['type' => 'quotations']) }}"
								...
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
									stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
									<path
										d="M8 6h10.5a.5 .5 0 0 1 .5 .5v11a.5 .5 0 0 1 -.5 .5h-14.5a.5 .5 0 0 1 -.5 -.5v-11a.5 .5 0 0 1 .5 -.5h1.5" />
									<path d="M14 6v-3h-4v3" />
									<path d="M6 12h2" />
									<path d="M6 15h2" />
								</svg>
								Sebut Harga
