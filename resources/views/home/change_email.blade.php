...
@section('content')
	<div class="row">
		<div class="col-lg-9">
			...
			{!! Former::text('new_email')->label('Alamat Emel Baru')->required() !!}
			{!! Former::file('sijil_ssm')->label('Salinan Sijil SSM')->accept('application/pdf')->required() !!}
			{!! Former::file('sijil_ic')->label('Salinan Kad Pengenalan Pemilik / Pengarah')->accept('application/pdf')->required() !!}
			{!! Former::submit('Kemaskini')->class('btn bg-blue-selangor') !!}
			{!! Former::close() !!}
		</div>
