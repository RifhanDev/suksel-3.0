...
@section('content')
	<div class="row">
		<div class="col-lg-9">
			...
			{!! Former::text('name')->label('Nama Anda')->required() !!}
			{!! Former::text('company_name')->label('Nama Syarikat') !!}
			{!! Former::text('email')->label('Alamat Emel Anda')->required() !!}
			{!! Former::text('subject')->label('Tajuk / Perkara')->required() !!}
			{!! Former::textarea('body')->label('Pesanan')->required()->rows(10) !!}
