													...
													<td>
														<div class="btn-group">
															@if (empty($tender->approver_id))
																<a class="btn btn-primary btn-sm" href="{{ action('tenders.edit', $tender->id) }}">
															...
															@if ($tender->canCancel() && $tender->publish_prices)
																<a class="btn btn-danger btn-sm" href="{{ route('tenders.publishPrices', $tender->id) }}">
																	<i class="ti ti-x me-1"></i>Batal Siar
																</a>
															@else
																<a class="btn btn-warning btn-sm" href="{{ route('tenders.publishPrices', $tender->id) }}">
