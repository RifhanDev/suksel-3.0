			...
			@if (Auth::check())
				<div class="btn-group mb-3">
					@if (Auth::user()->hasRole('Admin'))
						<a href="{{ route('agency.edit', $organizationunit->id) }}" class="btn btn-warning btn-sm">
					...
					<div class="row">
						<div class="col-md-2">
							<div class="nav flex-column nav-pills" role="tablist">
								...
								<a href="{{ action('OrganizationUnitsController@agencyResults', [$organizationunit->id, 'type' => 'tenders']) }}"
									class="nav-link @if (Request::get('type') == 'tenders') active @endif" role="tab">
									<i class="ti ti-file-text me-2"></i>Tender
								</a>
								<a href="{{ action('OrganizationUnitsController@agencyResults', [$organizationunit->id, 'type' => 'quotations']) }}"
