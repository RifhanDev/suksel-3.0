        ...
        <div class="mb-3 mb-lg-0">
            <div class="d-flex align-items-center flex-wrap gap-2">
                ...
                @if ($currentUser->confirmed == 1)
                    <span
                        class="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill border bg-white shadow-sm mt-1 mt-sm-0"
        ...
        <div class="p-4 bg-white rounded-bottom">
            ...
            <div class="d-flex flex-wrap gap-3">
                ...
                @if (Auth::user()->hasRole('Admin') && !$currentUser->confirmed)
                    <a href="{{ action('UsersController@resendConfirmation', $currentUser->id) }}"
                ...
                @if ($currentUser->canSetPassword())
                    <a href="{{ action('UsersController@getSetPassword', $currentUser->id) }}"
