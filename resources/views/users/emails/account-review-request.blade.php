...
<head>
	...
	<title>Pendaftaran Diluluskan | Sistem Tender Online Selangor</title>
	<style type="text/css">
		html {
														...
														<div style="line-height: 24px;">
															<font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 16px;">
																<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
																	Adalah dimaklumkan, Sistem Tender Selangor akan menjalankan rutin Semakan Akaun Pengguna pada setiap 6
																	bulan. <br><br>
																	Sila klik pada butang dibawah untuk mengelakkan akaun anda ditukarkan status kepada tidak aktif dan
																	akan disekat.<br><br>
																</span>
															</font>
														</div>
									...
									<tr>
										<td align="center">
											<div style="line-height:24px;">
												...
												<a href="{{ url('users/' . $id . '/account-review') }}" target="_blank"
													style="background: #F3565D; font-family: Arial, Helvetica, sans-serif; font-size: 13px; padding: 15px 30px;  text-decoration: none;">
