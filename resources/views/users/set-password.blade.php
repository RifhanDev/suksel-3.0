...
@section('styles')
<style>
    .card-accent-top { border-top: 4px solid var(--sg-red); }
    ...
    .info-sidebar::before {
        ...
        background: white; opacity: 0.05; border-radius: 50%; pointer-events: none;
    }

    /* Text Adjustments */
    .info-sidebar h5, .info-sidebar .fw-bold { color: white !important; }
    .info-sidebar .text-muted { color: rgba(255, 255, 255, 0.7) !important; }

    .icon-box-sidebar {
        background: rgba(255, 255, 255, 0.15); border: 1px solid rgba(255, 255, 255, 0.2);
        color: white; width: 50px; height: 50px; display: inline-flex; align-items: center; justify-content: center;
        border-radius: 50%; margin-bottom: 1rem; backdrop-filter: blur(5px);
    }
    ...
    .link-slide-underline:hover::after { width: 95%; }
</style>
@endsection
...
<form action="{{ url('users/' . $currentUser->id . '/reset_password') }}" method="POST">
            ...
            <div class="col-lg-8 bg-white">
                <div class="p-5">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-4 pb-3 border-bottom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-secondary"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"></path></svg>
                    ...
                    <div class="row g-4">
                        <!-- Password -->
                        <div class="col-12">
                            <label for="password" class="form-label fw-bold text-dark">Kata Laluan Baru <span class="text-danger">*</span></label>
                            <input type="password" 
                            ...
                            <div class="form-text text-muted small mt-2">
                                <i class="ti ti-info-circle me-1"></i> Sekurang-kurangnya 8 aksara dan kombinasi antara abjad dan nombor, huruf besar dan kecil.
                            </div>
                        </div>

                        <!-- Confirm Password -->
                        <div class="col-12">
                            <label for="password_confirmation" class="form-label fw-bold text-dark">Pastikan Kata Laluan <span class="text-danger">*</span></label>
                            <input type="password" 
    ...
    <div class="w-100 bg-white border border-top-0 shadow-lg rounded-3 p-3 z-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                @if ($currentUser->hasRole('Vendor'))
                    <a href="{{ asset('vendors/' . $currentUser->vendor_id) }}" class="text-secondary text-decoration-none d-flex align-items-center gap-2 ps-0 link-slide-underline">
                ...
                @else
                    <div class="d-flex gap-3">
                        @if (App\User::canList())
                            <a href="{{ asset('users') }}" class="text-secondary text-decoration-none d-flex align-items-center gap-2 ps-0 link-slide-underline">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
                        ...
                        @if (isset($currentUser) && $user->canUpdate())
                            <a href="{{ asset('users/' . $currentUser->id . '/edit') }}" class="btn btn-light border d-flex align-items-center gap-2 fw-medium">
