...
@section('content')
	...
	<form id="saveForm" name="saveForm"
		action="{{ route('chatbot-manager.category.update', ['category' => $data->enc_id]) }}"
		method="POST">
		@csrf
		@method('PUT')
				...
				<div class="row g-3">
					...
					<div class="col-12">
						<div class="form-check form-switch d-flex align-items-start gap-3">
							<input type="checkbox" class="form-check-input mt-1" id="show_none_btn" name="show_none_btn"
								value="1" {{ ($data->show_none_btn ?? 0) == '1' ? 'checked' : '' }}
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<form action="{{ route('chatbot-manager.category.destroy', ['category' => $data->enc_id]) }}" method="POST" class="d-inline m-0">
						@csrf
						@method('DELETE')
