	...
	@if ($user && ($vendor = $user->vendor))
						...
						<div class="card-body">
							<ul class="list-group">
								...
								<li class="list-group-item">
									...
									CADANGAN KERJA-KERJA PENYELENGGARAAN LANDSKAP LEMBUT BAGI KAWASAN SUNGAI PELEK HINGGA TELUK MERBAU UNTUK MAJLIS
									PERBANDARAN SEPANG
							</ul>
						</div>
					</div>
						...
						<div class="card-body">
							<ul class="list-group">
								<li class="list-group-item">
									...
									Cadangan Kerja-Kerja Membekal, Memasang, Menguji Dan Mengujiterima Sistem Penyaman Udara Jenis “Split Unit” Dan
									Kerja-Kerja Yang Berkaitan Di Stor Fail Berpusat Jabatan Bangunan Kompleks Majlis Perbandaran Selayang.
								</li>
								<br>
								<li class="list-group-item">
									<div class="label label-primary pull-right">+14d</div>
						...
						<div class="card-body">
							<ul class="list-group">
								<li class="list-group-item">
									...
									Cadangan Membekal, Menghantar, Memasang Dan Mengujiterima Sistem Pelarasan Berpusat Dan Sistem Perundangan
									Berpusat Untuk Majlis Bandaraya Shah Alam.
								</li>
							</ul>
						</div>
					</div>
						...
						<div class="card-body">
							<ul class="list-group">
								<li class="list-group-item">
									...
									Cadangan sistem pelintas jalan sementara berdekatan LRT Asia Jaya dan Hotel Cyrstal Crown untuk Majlis Bandaraya
									Petaling Jaya, Selangor
								</li>
								<br>
								<li class="list-group-item">
									<div class="label label-default pull-right">Cancel</div>
									Perolehan Pembangunan Sistem MyAset Bagi Bahagian Pengurusan Aset Dan Kualiti (BPAK), Jabatan Khidmat
									Pengurusan, Majlis Perbandaran Kajang
								</li>
							</ul>
						</div>
					</div>
		...
		@elseif($vendor->isBlacklisted())
			<div class="alert alert-danger">
				Your company is blacklisted and will not be able to participate in any tender and quotations until
				{{ $vendor->blacklisted_until }} because of: {{ $vendor->blacklist_reason }}.
										...
										<table class="table no-margin">
											<tbody>
												@foreach ($tenders as $tender)
													<tr>
														<td>
															{{ link_to_action('OrganizationUnitsController@show', $tender->tenderer->name, [$tender->organization_unit_id]) }}
														</td>
														<td><a
																href="{{ action('TendersController@show', $tender->id) }}">{{ $tender->ref_number }}<br />{{ $tender->name }}</a>
														</td>
